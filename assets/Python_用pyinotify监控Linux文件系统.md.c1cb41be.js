import{_ as s,v as n,b as a,R as p}from"./chunks/framework.780d3f64.js";const u=JSON.parse('{"title":"用pyinotify监控Linux文件系统","description":"","frontmatter":{"title":"用pyinotify监控Linux文件系统","tags":["Python","Pyinotify"],"categories":["Python"]},"headers":[],"relativePath":"Python/用pyinotify监控Linux文件系统.md","filePath":"Python/用pyinotify监控Linux文件系统.md","lastUpdated":1625641181000}'),l={name:"Python/用pyinotify监控Linux文件系统.md"},o=p(`<h3 id="模块事件" tabindex="-1">模块事件 <a class="header-anchor" href="#模块事件" aria-label="Permalink to &quot;模块事件&quot;">​</a></h3><p><img src="http://upload-images.jianshu.io/upload_images/4262139-329a0bbbd5f85c99.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><h3 id="过程" tabindex="-1"><strong>过程</strong> <a class="header-anchor" href="#过程" aria-label="Permalink to &quot;**过程**&quot;">​</a></h3><p>wm = pyinotify.WatchManager() 创建监控实例 wm.add_watch(path, pyinotify.ALL_EVENTS, res=True) # 添加监控的对象 notifier = pyinotify.Notifier(wm, ev) # 绑定一个事件 notifier.loop() # 运行监控</p><h3 id="sys模块" tabindex="-1"><strong>sys模块</strong> <a class="header-anchor" href="#sys模块" aria-label="Permalink to &quot;**sys模块**&quot;">​</a></h3><p>sys.argv 位置参数 <br></p><h3 id="例子-监控linux下文件系统" tabindex="-1">例子:监控linux下文件系统 <a class="header-anchor" href="#例子-监控linux下文件系统" aria-label="Permalink to &quot;例子:监控linux下文件系统&quot;">​</a></h3><p><strong>代码如下:</strong></p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#!/usr/bin/env python</span></span>
