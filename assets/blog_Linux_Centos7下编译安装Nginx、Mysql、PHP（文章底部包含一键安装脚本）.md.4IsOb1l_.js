import{_ as a,o as n,c as p,av as e}from"./chunks/framework.B5CsnGBr.js";const m=JSON.parse('{"title":"Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）","description":"","frontmatter":{"title":"Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）","tags":["Centos","Linux","Nginx","Mysql","PHP"],"categories":["Linux"]},"headers":[],"relativePath":"blog/Linux/Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）.md","filePath":"blog/Linux/Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）.md","lastUpdated":1778156131000}'),l={name:"blog/Linux/Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）.md"};function i(t,s,c,o,r,d){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h2 id="实现环境" tabindex="-1">实现环境 <a class="header-anchor" href="#实现环境" aria-label="Permalink to &quot;实现环境&quot;">​</a></h2><blockquote><p>Centos 7 64位<br> IP地址：172.16.0.20 Nginx：1.12.0 Mysql：5.7.18 PHP：7.1.4 yum源：aliyun源</p></blockquote><h6 id="如果你的系统是新安装的redhat-7或-centos-7-可以使用我的一键优化脚本优化系统-有利于系统的使用和下面的安装。点击我查看" tabindex="-1">如果你的系统是新安装的redhat 7或 Centos 7 ，可以使用我的一键优化脚本优化系统，有利于系统的使用和下面的安装。<a href="http://www.jianshu.com/p/f9ea135af86a" target="_blank" rel="noreferrer">点击我查看</a> <a class="header-anchor" href="#如果你的系统是新安装的redhat-7或-centos-7-可以使用我的一键优化脚本优化系统-有利于系统的使用和下面的安装。点击我查看" aria-label="Permalink to &quot;如果你的系统是新安装的redhat 7或 Centos 7 ，可以使用我的一键优化脚本优化系统，有利于系统的使用和下面的安装。[点击我查看](http://www.jianshu.com/p/f9ea135af86a)&quot;">​</a></h6><h2 id="首先下载好我们的需要的包" tabindex="-1">首先下载好我们的需要的包 <a class="header-anchor" href="#首先下载好我们的需要的包" aria-label="Permalink to &quot;首先下载好我们的需要的包&quot;">​</a></h2><p>创建一个目录存放下载的软件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[root@localhost ~]# mkdir /software</span></span>
...
<span class="line"><span>4月 18 14:06:58 localhost.localdomain systemd[1]: Started nginx - high performance web server.</span></span></code></pre></div><h3 id="设置nginx开机启动" tabindex="-1">设置nginx开机启动 <a class="header-anchor" href="#设置nginx开机启动" aria-label="Permalink to &quot;设置nginx开机启动&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[root@localhost nginx-1.12.0]# systemctl enable nginx</span></span></code></pre></div><p>nginx安装完成，下面安装mysql</p><br> ## 安装MySQL ### 安装依赖包 <div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[root@localhost nginx-1.12.0]# cd /software/</span></span>
...
<span class="line"><span>[root@localhost software]# sh one-click-install-lnmp.sh</span></span></code></pre></div><p>等待安装完成即可。</p>`,142)])])}const g=a(l,[["render",i]]);export{m as __pageData,g as default};
