import{_ as n,v as a,b as e,L as l,R as s}from"./chunks/framework.780d3f64.js";const u=JSON.parse('{"title":"Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）","description":"","frontmatter":{"title":"Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）","tags":["Centos","Linux","Nginx","Mysql","PHP"],"categories":["Linux"]},"headers":[],"relativePath":"Linux/Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）.md","filePath":"Linux/Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）.md","lastUpdated":1625642631000}'),p={name:"Linux/Centos7下编译安装Nginx、Mysql、PHP（文章底部包含一键安装脚本）.md"},o=s(`<h2 id="实现环境" tabindex="-1">实现环境 <a class="header-anchor" href="#实现环境" aria-label="Permalink to &quot;实现环境&quot;">​</a></h2><blockquote><p>Centos 7 64位<br> IP地址：172.16.0.20 Nginx：1.12.0 Mysql：5.7.18 PHP：7.1.4 yum源：aliyun源</p></blockquote><h6 id="如果你的系统是新安装的redhat-7或-centos-7-可以使用我的一键优化脚本优化系统-有利于系统的使用和下面的安装。点击我查看" tabindex="-1">如果你的系统是新安装的redhat 7或 Centos 7 ，可以使用我的一键优化脚本优化系统，有利于系统的使用和下面的安装。<a href="http://www.jianshu.com/p/f9ea135af86a" target="_blank" rel="noreferrer">点击我查看</a> <a class="header-anchor" href="#如果你的系统是新安装的redhat-7或-centos-7-可以使用我的一键优化脚本优化系统-有利于系统的使用和下面的安装。点击我查看" aria-label="Permalink to &quot;如果你的系统是新安装的redhat 7或 Centos 7 ，可以使用我的一键优化脚本优化系统，有利于系统的使用和下面的安装。[点击我查看](http://www.jianshu.com/p/f9ea135af86a)&quot;">​</a></h6><h2 id="首先下载好我们的需要的包" tabindex="-1">首先下载好我们的需要的包 <a class="header-anchor" href="#首先下载好我们的需要的包" aria-label="Permalink to &quot;首先下载好我们的需要的包&quot;">​</a></h2><p>创建一个目录存放下载的软件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost ~]# mkdir /software</span></span>
...
<span class="line"><span style="color:#24292e;">[root@localhost software]# setenforce 0</span></span></code></pre></div><h2 id="开始安装nginx" tabindex="-1">开始安装nginx <a class="header-anchor" href="#开始安装nginx" aria-label="Permalink to &quot;开始安装nginx&quot;">​</a></h2><h3 id="创建www账户-用来启动nginx" tabindex="-1">创建www账户 用来启动nginx <a class="header-anchor" href="#创建www账户-用来启动nginx" aria-label="Permalink to &quot;创建www账户 用来启动nginx&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# useradd www -s /sbin/nologin</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost software]# useradd www -s /sbin/nologin</span></span></code></pre></div><h3 id="安装依赖的包" tabindex="-1">安装依赖的包 <a class="header-anchor" href="#安装依赖的包" aria-label="Permalink to &quot;安装依赖的包&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# yum -y install pcre pcre-devel zlib zlib-devel gcc-c++ gcc openssl*</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost software]# yum -y install pcre pcre-devel zlib zlib-devel gcc-c++ gcc openssl*</span></span></code></pre></div><h3 id="解压nginx源码包" tabindex="-1">解压Nginx源码包 <a class="header-anchor" href="#解压nginx源码包" aria-label="Permalink to &quot;解压Nginx源码包&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">root@localhost software]# tar zxvf nginx-1.12.0.tar.gz</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">root@localhost software]# tar zxvf nginx-1.12.0.tar.gz</span></span></code></pre></div><h3 id="进入解压后的目录-对nginx进行配置" tabindex="-1">进入解压后的目录，对Nginx进行配置 <a class="header-anchor" href="#进入解压后的目录-对nginx进行配置" aria-label="Permalink to &quot;进入解压后的目录，对Nginx进行配置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# cd nginx-1.12.0/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@localhost nginx-1.12.0]# ./configure --user=www --group=www --prefix=/usr/local/nginx --with-http_realip_module --with-http_sub_module --with-http_gzip_static_module --with-http_stub_status_module  --with-pcre</span></span></code></pre></div><h3 id="编译和安装" tabindex="-1">编译和安装 <a class="header-anchor" href="#编译和安装" aria-label="Permalink to &quot;编译和安装&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost nginx-1.12.0]# make &amp;&amp; make install</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost nginx-1.12.0]# make &amp;&amp; make install</span></span></code></pre></div><h3 id="启动nginx" tabindex="-1">启动Nginx <a class="header-anchor" href="#启动nginx" aria-label="Permalink to &quot;启动Nginx&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost nginx-1.12.0]# /usr/local/nginx/sbin/nginx</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost nginx-1.12.0]# /usr/local/nginx/sbin/nginx</span></span></code></pre></div><h3 id="浏览器访问测试是否ok" tabindex="-1">浏览器访问测试是否ok <a class="header-anchor" href="#浏览器访问测试是否ok" aria-label="Permalink to &quot;浏览器访问测试是否ok&quot;">​</a></h3><p><img src="http://upload-images.jianshu.io/upload_images/4262139-42bdfeb1435bb703.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><h3 id="关闭nginx进程" tabindex="-1">关闭Nginx进程 <a class="header-anchor" href="#关闭nginx进程" aria-label="Permalink to &quot;关闭Nginx进程&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost nginx-1.12.0]# killall nginx</span></span>
...
<span class="line"><span style="color:#24292e;">[root@localhost nginx-1.12.0]# ps -ef|grep nginx</span></span></code></pre></div><h3 id="nginx命令做软连接方便使用" tabindex="-1">nginx命令做软连接方便使用 <a class="header-anchor" href="#nginx命令做软连接方便使用" aria-label="Permalink to &quot;nginx命令做软连接方便使用&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost nginx-1.12.0]# ln -s /usr/local/nginx/sbin/nginx /sbin/nginx</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost nginx-1.12.0]# ln -s /usr/local/nginx/sbin/nginx /sbin/nginx</span></span></code></pre></div><h3 id="编写nginx启动脚本" tabindex="-1">编写nginx启动脚本 <a class="header-anchor" href="#编写nginx启动脚本" aria-label="Permalink to &quot;编写nginx启动脚本&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">cat &gt;&gt; /usr/lib/systemd/system/nginx.service &lt;&lt; EOF</span></span>
...
<span class="line"><span style="color:#24292e;">EOF</span></span></code></pre></div><h3 id="修改完systemctl服务-需要重新加载下daemon" tabindex="-1">修改完systemctl服务，需要重新加载下daemon <a class="header-anchor" href="#修改完systemctl服务-需要重新加载下daemon" aria-label="Permalink to &quot;修改完systemctl服务，需要重新加载下daemon&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost nginx-1.12.0]# systemctl daemon-reload</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost nginx-1.12.0]# systemctl daemon-reload</span></span></code></pre></div><h3 id="用systemctl启动nginx服务-并查看状态" tabindex="-1">用systemctl启动Nginx服务，并查看状态 <a class="header-anchor" href="#用systemctl启动nginx服务-并查看状态" aria-label="Permalink to &quot;用systemctl启动Nginx服务，并查看状态&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost nginx-1.12.0]# systemctl start nginx</span></span>
...
<span class="line"><span style="color:#24292e;">4月 18 14:06:58 localhost.localdomain systemd[1]: Started nginx - high performance web server.</span></span></code></pre></div><h3 id="设置nginx开机启动" tabindex="-1">设置nginx开机启动 <a class="header-anchor" href="#设置nginx开机启动" aria-label="Permalink to &quot;设置nginx开机启动&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost nginx-1.12.0]# systemctl enable nginx</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost nginx-1.12.0]# systemctl enable nginx</span></span></code></pre></div><p>nginx安装完成，下面安装mysql</p><br>`,45),c=s(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost nginx-1.12.0]# cd /software/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@localhost software]# yum -y install ncurses ncurses-devel bison cmake gcc gcc-c++</span></span></code></pre></div><h3 id="创建用户和组" tabindex="-1">创建用户和组 <a class="header-anchor" href="#创建用户和组" aria-label="Permalink to &quot;创建用户和组&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# groupadd mysql</span></span>
...
<span class="line"><span style="color:#24292e;">[root@localhost software]# id mysql</span></span></code></pre></div><h3 id="解压mysql源码包" tabindex="-1">解压mysql源码包 <a class="header-anchor" href="#解压mysql源码包" aria-label="Permalink to &quot;解压mysql源码包&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# tar zxvf mysql-boost-5.7.18.tar.gz</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost software]# tar zxvf mysql-boost-5.7.18.tar.gz</span></span></code></pre></div><h3 id="进入解压后的目录-对mysql进行配置-5-5以上都是cmake" tabindex="-1">进入解压后的目录，对mysql进行配置（5.5以上都是cmake） <a class="header-anchor" href="#进入解压后的目录-对mysql进行配置-5-5以上都是cmake" aria-label="Permalink to &quot;进入解压后的目录，对mysql进行配置（5.5以上都是cmake）&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# cd mysql-5.7.18/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@localhost mysql-5.7.18]# cmake . -DCMAKE_INSTALL_PREFIX=/usr/local/mysql -DMYSQL_UNIX_ADDR=/usr/local/mysql/mysql.sock -DSYSCONFDIR=/usr/local/mysql/etc -DSYSTEMD_PID_DIR=/usr/local/mysql -DDEFAULT_CHARSET=utf8  -DDEFAULT_COLLATION=utf8_general_ci -DWITH_INNOBASE_STORAGE_ENGINE=1 -DWITH_ARCHIVE_STORAGE_ENGINE=1 -DWITH_BLACKHOLE_STORAGE_ENGINE=1 -DWITH_PERFSCHEMA_STORAGE_ENGINE=1 -DMYSQL_DATADIR=/usr/local/mysql/data -DWITH_BOOST=boost -DWITH_SYSTEMD=1</span></span></code></pre></div><p>记住这个/usr/local/mysql/mysql.sock，php连接mysql会用到。</p><h3 id="编译和安装-1" tabindex="-1">编译和安装 <a class="header-anchor" href="#编译和安装-1" aria-label="Permalink to &quot;编译和安装&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost mysql-5.7.18]# make &amp;&amp; make install</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost mysql-5.7.18]# make &amp;&amp; make install</span></span></code></pre></div><h3 id="初始化数据库及启动" tabindex="-1">初始化数据库及启动 <a class="header-anchor" href="#初始化数据库及启动" aria-label="Permalink to &quot;初始化数据库及启动&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost mysql-5.7.18]# chown -R mysql.mysql /usr/local/mysql/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@localhost data]# ps -ef|grep mysql</span></span></code></pre></div><h3 id="设置mysql开机启动" tabindex="-1">设置mysql开机启动 <a class="header-anchor" href="#设置mysql开机启动" aria-label="Permalink to &quot;设置mysql开机启动&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost mysql]# systemctl enable mysqld</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost mysql]# systemctl enable mysqld</span></span></code></pre></div><h3 id="查看mysql启动状态" tabindex="-1">查看Mysql启动状态 <a class="header-anchor" href="#查看mysql启动状态" aria-label="Permalink to &quot;查看Mysql启动状态&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost mysql]# systemctl status mysqld</span></span>
...
<span class="line"><span style="color:#24292e;">Query OK, 0 rows affected (0.01 sec)</span></span></code></pre></div><h3 id="查看授权的用户表" tabindex="-1">查看授权的用户表 <a class="header-anchor" href="#查看授权的用户表" aria-label="Permalink to &quot;查看授权的用户表&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost mysql]# mysql</span></span>
<span class="line"><span style="color:#e1e4e8;">Welcome to the MySQL monitor.  Commands end with ; or \\g.</span></span>
<span class="line"><span style="color:#e1e4e8;">Server version: 5.7.18 Source distribution</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">Oracle is a registered trademark of Oracle Corporation and/or its</span></span>
...
<span class="line"><span style="color:#24292e;">+--------------------+</span></span>
<span class="line"><span style="color:#24292e;">2 rows in set (0.00 sec)</span></span></code></pre></div><br><h2 id="php-7-安装" tabindex="-1">PHP 7 安装 <a class="header-anchor" href="#php-7-安装" aria-label="Permalink to &quot;PHP 7 安装&quot;">​</a></h2><p>PHP 7 在15年年底推出，PHP官方说的比 PHP 5 快2倍，就为这个，这个鲜必须尝。不过有个很值得注意的地方是，虽然 PHP 7 增加了不少新特性，但也很多地方是向后不兼容的，例如 mysql 扩展，在 PHP 7 中已经被删除。 现在最新版本是7.1.4。</p><h3 id="进入software目录" tabindex="-1">进入software目录 <a class="header-anchor" href="#进入software目录" aria-label="Permalink to &quot;进入software目录&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost mysql]# cd /software/</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost mysql]# cd /software/</span></span></code></pre></div><h3 id="接着解压php源码包" tabindex="-1">接着解压php源码包 <a class="header-anchor" href="#接着解压php源码包" aria-label="Permalink to &quot;接着解压php源码包&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# tar zxvf php-7.1.4.tar.gz</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost software]# tar zxvf php-7.1.4.tar.gz</span></span></code></pre></div><h3 id="再进入解压后的文件夹" tabindex="-1">再进入解压后的文件夹 <a class="header-anchor" href="#再进入解压后的文件夹" aria-label="Permalink to &quot;再进入解压后的文件夹&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# cd php-7.1.4/</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost software]# cd php-7.1.4/</span></span></code></pre></div><p>这里将只安装一些常用的扩展，大家可以根据自己的实际需要进行增减，可以通过以下命令查看PHP安装是具体有有些扩展和选项：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost php-7.1.4]# ./configure --help</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost php-7.1.4]# ./configure --help</span></span></code></pre></div><p>有接近300个选项。</p><h3 id="安装之前要先安装那些准备装的扩展要用到的软件模块" tabindex="-1">安装之前要先安装那些准备装的扩展要用到的软件模块 <a class="header-anchor" href="#安装之前要先安装那些准备装的扩展要用到的软件模块" aria-label="Permalink to &quot;安装之前要先安装那些准备装的扩展要用到的软件模块&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost php-7.1.4]# yum -y install libjpeg libjpeg-devel libpng libpng-devel freetype freetype-devel libxml2 libxml2-devel zlib zlib-devel curl curl-devel openssl openssl-devel</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost php-7.1.4]# yum -y install libjpeg libjpeg-devel libpng libpng-devel freetype freetype-devel libxml2 libxml2-devel zlib zlib-devel curl curl-devel openssl openssl-devel</span></span></code></pre></div><h3 id="接下来-configure-php-7" tabindex="-1">接下来 configure PHP 7 <a class="header-anchor" href="#接下来-configure-php-7" aria-label="Permalink to &quot;接下来 configure PHP 7&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost php-7.1.4]# ./configure --prefix=/usr/local/php --enable-fpm --with-fpm-user=nginx --with-fpm-group=nginx --with-mysqli --with-zlib --with-curl --with-gd --with-jpeg-dir --with-png-dir --with-freetype-dir --with-openssl --enable-mbstring --enable-xml --enable-session --enable-ftp --enable-pdo -enable-tokenizer --enable-zip</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost php-7.1.4]# ./configure --prefix=/usr/local/php --enable-fpm --with-fpm-user=nginx --with-fpm-group=nginx --with-mysqli --with-zlib --with-curl --with-gd --with-jpeg-dir --with-png-dir --with-freetype-dir --with-openssl --enable-mbstring --enable-xml --enable-session --enable-ftp --enable-pdo -enable-tokenizer --enable-zip</span></span></code></pre></div><p>上面已经提到，PHP 7 已经删除了 MySQL 扩展，所以 -with-mysql 不再是一个有效的选项。这里用 MySQLi 或 PDO 代替。 其中 --prefix 是安装目录，上面提到在同一个服务器安装多个 PHP 版本，这个 --prefix 设定是很有必要的。至于其他扩展大家按实际增减。 如果 configure 成功的话，将会看到以下类似字样：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">+--------------------------------------------------------------------+</span></span>
...
<span class="line"><span style="color:#24292e;">+--------------------------------------------------------------------+</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">Thank you for using PHP.</span></span></code></pre></div><h3 id="编译和安装-2" tabindex="-1">编译和安装 <a class="header-anchor" href="#编译和安装-2" aria-label="Permalink to &quot;编译和安装&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost php-7.1.4]# make &amp;&amp; make install</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost php-7.1.4]# make &amp;&amp; make install</span></span></code></pre></div><p>好，PHP 7 已经安装完成，下面进行配置</p><h3 id="php-的配置文档" tabindex="-1">PHP 的配置文档 <a class="header-anchor" href="#php-的配置文档" aria-label="Permalink to &quot;PHP 的配置文档&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost php-7.1.4]# cp php.ini-development /usr/local/php/lib/php.ini</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost php-7.1.4]# cp php.ini-development /usr/local/php/lib/php.ini</span></span></code></pre></div><p>php.ini 路径应该放在 PREFIX/lib 文件夹，除非在安装的时候通过这个选项修改 --with-config-file-path=PATH 如果安装 PHP 时没有指明 --prefix ，那么就 php.ini 路径就是 /usr/local/lib/php.ini 。刚才安装时有指明 --prefix ，所以是 /usr/local/php/lib/php.ini 然后根据实际自己需要修改 php.ini。 查找 mysqli.default_socket，修改成 mysqli.default_socket = /usr/local/mysql/mysql.sock：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost php-7.1.4]# grep mysqli.default_socket  /usr/local/php/lib/php.ini</span></span>
...
<span class="line"><span style="color:#24292e;">4月 17 15:37:06 localhost.localdomain systemd[1]: Starting The PHP FastCGI Process Manager...</span></span></code></pre></div><p>好，php-fpm 已经成功启动，那就立即建个网站看看</p><h2 id="配置-nginx-站点" tabindex="-1">配置 Nginx 站点 <a class="header-anchor" href="#配置-nginx-站点" aria-label="Permalink to &quot;配置 Nginx 站点&quot;">​</a></h2><p>先建立一个 lnmp 站点，路径是 /var/www/html</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost php-7.1.4]# mkdir -p /var/www/html</span></span>
