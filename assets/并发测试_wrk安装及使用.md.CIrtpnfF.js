import{_ as s,o as a,c as n,ai as p}from"./chunks/framework.Ck6v7yFa.js";const g=JSON.parse('{"title":"wrk安装及使用","description":"","frontmatter":{"title":"wrk安装及使用","tags":["Shell","并发测试"],"categories":["并发测试"]},"headers":[],"relativePath":"并发测试/wrk安装及使用.md","filePath":"并发测试/wrk安装及使用.md","lastUpdated":1625641181000}'),e={name:"并发测试/wrk安装及使用.md"},t=p(`<p>用过了很多压测工具，却一直没找到中意的那款。最近试了wrk感觉不错，写下这份使用指南给自己备忘用，如果能帮到你，那也很好。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><p>wrk支持大多数类UNIX系统，不支持windows。需要操作系统支持LuaJIT和OpenSSL，不过不用担心，大多数类Unix系统都支持。安装wrk非常简单，只要从github上下载wrk源码，在项目路径下执行make命令即可。</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> clone</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://github.com/wg/wrk</span></span>
