import{_ as n,v as l,b as p,L as a,R as s}from"./chunks/framework.780d3f64.js";const g=JSON.parse('{"title":"Centos-7安装zabbix","description":"","frontmatter":{"title":"Centos-7安装zabbix","tags":["Centos","Linux","Zabbix","监控"],"categories":["Linux"]},"headers":[],"relativePath":"Linux/Centos-7安装zabbix.md","filePath":"Linux/Centos-7安装zabbix.md","lastUpdated":1625641181000}'),e={name:"Linux/Centos-7安装zabbix.md"},o=s(`<h2 id="本例环境使用centos7-3-64位" tabindex="-1">本例环境使用Centos7.3 64位 <a class="header-anchor" href="#本例环境使用centos7-3-64位" aria-label="Permalink to &quot;本例环境使用Centos7.3 64位&quot;">​</a></h2><p><strong>安装zabbix需要mysql的支持，下面是快速安装LNMP的方法（使用EZHTTP安装）</strong></p><h2 id="安装lnmp" tabindex="-1">安装LNMP <a class="header-anchor" href="#安装lnmp" aria-label="Permalink to &quot;安装LNMP&quot;">​</a></h2><p><strong>首先创建一个目录存放下载文件：</strong></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[root@localhost </span><span style="color:#F97583;">~</span><span style="color:#E1E4E8;">]# mkdir /software</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6F42C1;">mysql&gt;</span><span style="color:#24292E;"> </span><span style="color:#032F62;">flush</span><span style="color:#24292E;"> </span><span style="color:#032F62;">privileges</span><span style="color:#24292E;">;</span></span></code></pre></div><h3 id="数据库导入zabbix-template" tabindex="-1">数据库导入zabbix template <a class="header-anchor" href="#数据库导入zabbix-template" aria-label="Permalink to &quot;数据库导入zabbix template&quot;">​</a></h3><p>看yum安装的zabbix-server-mysql-3.x.x 这个文件的版本是多少就改成多少</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# zcat /usr/share/doc/zabbix-server-mysql-3.2.4/create.sql.gz |mysql -uzabbix -pzabbix -b zabbix</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost software]# zcat /usr/share/doc/zabbix-server-mysql-3.2.4/create.sql.gz |mysql -uzabbix -pzabbix -b zabbix</span></span></code></pre></div><h3 id="配置zabbix-server" tabindex="-1">配置Zabbix server <a class="header-anchor" href="#配置zabbix-server" aria-label="Permalink to &quot;配置Zabbix server&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">vi /etc/zabbix/zabbix_server.conf</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">vi /etc/zabbix/zabbix_server.conf</span></span></code></pre></div><p>配置下面的几个参数 带#号的就去掉#号，并修改其值</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">ListenPort=10051</span></span>
...
<span class="line"><span style="color:#6A737D;">## Line 147 - Specify Zabbix server Hostname or IP address</span></span>
<span class="line"></span>
<span class="line"><span style="color:#24292E;">Hostname</span><span style="color:#D73A49;">=</span><span style="color:#005CC5;">127.0</span><span style="color:#032F62;">.0.1</span></span></code></pre></div><h3 id="修改php-设置" tabindex="-1">修改PHP 设置 <a class="header-anchor" href="#修改php-设置" aria-label="Permalink to &quot;修改PHP 设置&quot;">​</a></h3><p>修改php.ini为zabbix 建议的设置 编辑文件 php.ini,</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost software]# vi /usr/local/php/etc/php.ini</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost software]# vi /usr/local/php/etc/php.ini</span></span></code></pre></div><p>设置下面的参数：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">max_execution_time</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">300</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292e;">&lt;/IfModule&gt;</span></span></code></pre></div><p>然后重启apache、mysql、php、zabbix-server 浏览器输入ip/setup.php 即可进入zabbix初次web安装界面</p><h3 id="方法二-使用-nginx-服务器" tabindex="-1">方法二：使用 Nginx 服务器 <a class="header-anchor" href="#方法二-使用-nginx-服务器" aria-label="Permalink to &quot;方法二：使用 Nginx 服务器&quot;">​</a></h3><p>配置zabbix-web站点文件</p><p>把zabbix程序文件拷贝到我们指定的目录，并修改属主和属组</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[root@localhost software]# cp -r /usr/share/zabbix /var/www/</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6F42C1;">systemctl</span><span style="color:#24292E;"> </span><span style="color:#032F62;">enable</span><span style="color:#24292E;"> </span><span style="color:#032F62;">zabbix-agent</span></span></code></pre></div><h3 id="修改firewall-和selinux-设置" tabindex="-1">修改Firewall 和SELinux 设置 <a class="header-anchor" href="#修改firewall-和selinux-设置" aria-label="Permalink to &quot;修改Firewall 和SELinux 设置&quot;">​</a></h3><p>开放zabbix端口10050 and 10051</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">firewall-cmd --permanent --add-port=10050/tcp</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
