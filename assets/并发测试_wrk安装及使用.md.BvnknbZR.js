import{_ as s,c as a,o as n,ag as p}from"./chunks/framework.CgtRPpXH.js";const g=JSON.parse('{"title":"wrk安装及使用","description":"","frontmatter":{"title":"wrk安装及使用","tags":["Shell","并发测试"],"categories":["并发测试"]},"headers":[],"relativePath":"并发测试/wrk安装及使用.md","filePath":"并发测试/wrk安装及使用.md","lastUpdated":1625641181000}'),e={name:"并发测试/wrk安装及使用.md"},t=p(`<p>用过了很多压测工具，却一直没找到中意的那款。最近试了wrk感觉不错，写下这份使用指南给自己备忘用，如果能帮到你，那也很好。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><p>wrk支持大多数类UNIX系统，不支持windows。需要操作系统支持LuaJIT和OpenSSL，不过不用担心，大多数类Unix系统都支持。安装wrk非常简单，只要从github上下载wrk源码，在项目路径下执行make命令即可。</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> clone</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://github.com/wg/wrk</span></span>
...
<span class="line"><span>end</span></span></code></pre></div><p>通过在init方法中将三个HTTP request请求拼接在一起，实现每次发送三个请求，以使用HTTP pipeline。</p><p>转载自：<a href="http://www.cnblogs.com/xinzhao/p/6233009.html" target="_blank" rel="noreferrer">http://www.cnblogs.com/xinzhao/p/6233009.html</a></p>`,58),i=[t];function l(c,o,r,d,h,u){return n(),a("div",null,i)}const b=s(e,[["render",l]]);export{g as __pageData,b as default};
