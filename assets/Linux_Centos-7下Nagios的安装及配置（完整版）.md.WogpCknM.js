...
<span class="line"><span>-rw-r--r--   1 root  root    501028 4月  17 22:36 nrpe-3.1.0.tar.gz</span></span></code></pre></div><h2 id="安装nagios-server服务端" tabindex="-1">安装nagios-server服务端 <a class="header-anchor" href="#安装nagios-server服务端" aria-label="Permalink to &quot;安装nagios-server服务端&quot;">​</a></h2><h3 id="安装依赖包" tabindex="-1">安装依赖包 <a class="header-anchor" href="#安装依赖包" aria-label="Permalink to &quot;安装依赖包&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios software]# yum -y install httpd httpd-devel gcc glibc glibc-common gd gd-devel perl-devel perl-CPAN fcgi perl-FCGI perl-FCGI-ProcManager</span></span></code></pre></div><h3 id="解压nagios源码包" tabindex="-1">解压nagios源码包 <a class="header-anchor" href="#解压nagios源码包" aria-label="Permalink to &quot;解压nagios源码包&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios software]# tar zxvf nagios-4.3.1.tar.gz</span></span></code></pre></div><h3 id="进入解压后的目录" tabindex="-1">进入解压后的目录 <a class="header-anchor" href="#进入解压后的目录" aria-label="Permalink to &quot;进入解压后的目录&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios software]# cd nagios-4.3.1/</span></span></code></pre></div><h3 id="创建ngaios用户和组-把nginx启动用户www加入到nagios相关组" tabindex="-1">创建ngaios用户和组（把nginx启动用户www加入到nagios相关组） <a class="header-anchor" href="#创建ngaios用户和组-把nginx启动用户www加入到nagios相关组" aria-label="Permalink to &quot;创建ngaios用户和组（把nginx启动用户www加入到nagios相关组）&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nagios-4.3.1]# useradd nagios -s /sbin/nologin </span></span>
...
<span class="line"><span>[root@nagios nagios-4.3.1]# id -n -G www</span></span></code></pre></div><h3 id="配置nagios" tabindex="-1">配置nagios <a class="header-anchor" href="#配置nagios" aria-label="Permalink to &quot;配置nagios&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 nagios-4.3.1]# ./configure --with-command-group=nagcmd</span></span></code></pre></div><h3 id="编译和安装" tabindex="-1">编译和安装 <a class="header-anchor" href="#编译和安装" aria-label="Permalink to &quot;编译和安装&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nagios-4.3.1]# make all</span></span>
...
<span class="line"><span>[root@nagios nagios-4.3.1]# /usr/local/nagios/bin/nagios -v /usr/local/nagios/etc/nagios.cfg</span></span></code></pre></div><h3 id="生成apache配置文件" tabindex="-1">生成apache配置文件 <a class="header-anchor" href="#生成apache配置文件" aria-label="Permalink to &quot;生成apache配置文件&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nagios-4.3.1]# make install-webconf</span></span>
...
<span class="line"><span>*** Nagios/Apache conf file installed ***</span></span></code></pre></div><h3 id="生成nagios-web界面的验证信息" tabindex="-1">生成nagios web界面的验证信息 <a class="header-anchor" href="#生成nagios-web界面的验证信息" aria-label="Permalink to &quot;生成nagios web界面的验证信息&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nagios-4.3.1]# htpasswd -c /usr/local/nagios/etc/htpasswd.users nagios</span></span>
...
<span class="line"><span> LoadModule php7_module        modules/libphp7.so</span></span></code></pre></div><h3 id="apache配置文件参考" tabindex="-1">apache配置文件参考 <a class="header-anchor" href="#apache配置文件参考" aria-label="Permalink to &quot;apache配置文件参考&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios httpd]# grep -v &#39;^$&#39; /etc/httpd/conf/httpd.conf|grep -v &#39;#&#39;</span></span>
...
<span class="line"><span>IncludeOptional conf.d/*.conf</span></span></code></pre></div><h3 id="重新编译一下php-使其直接apache-也就是编译参数加上-with-apxs2" tabindex="-1">重新编译一下php，使其直接apache（也就是编译参数加上--with-apxs2） <a class="header-anchor" href="#重新编译一下php-使其直接apache-也就是编译参数加上-with-apxs2" aria-label="Permalink to &quot;重新编译一下php，使其直接apache（也就是编译参数加上--with-apxs2）&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nagios-4.3.1]# cd /software/php-7.1.4/</span></span>
...
<span class="line"><span>-rwxr-xr-x 1 root root 38908880 4月  24 10:34 /etc/httpd/modules/libphp7.so    ===&gt;    可以看到这个模块已经生成</span></span></code></pre></div><h3 id="启动apache" tabindex="-1">启动apache <a class="header-anchor" href="#启动apache" aria-label="Permalink to &quot;启动apache&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios httpd]# systemctl start httpd</span></span>
<span class="line"><span>[root@nagios httpd]# systemctl enable httpd</span></span></code></pre></div><h3 id="启动nagios" tabindex="-1">启动nagios <a class="header-anchor" href="#启动nagios" aria-label="Permalink to &quot;启动nagios&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>chkconfig nagios on</span></span>
<span class="line"><span>/etc/init.d/nagios start</span></span></code></pre></div><h3 id="在浏览器输入ip-8080-nagios测试nagios-web页面是否可以打开" tabindex="-1">在浏览器输入ip:8080/nagios测试nagios-web页面是否可以打开 <a class="header-anchor" href="#在浏览器输入ip-8080-nagios测试nagios-web页面是否可以打开" aria-label="Permalink to &quot;在浏览器输入ip:8080/nagios测试nagios-web页面是否可以打开&quot;">​</a></h3><p><img src="http://upload-images.jianshu.io/upload_images/4262139-9928ac01cfdf8142.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-55e6ef5cb388a862.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-9ba83971133bb8df.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><br><h2 id="安装nagios-plugins插件" tabindex="-1">安装nagios-plugins插件 <a class="header-anchor" href="#安装nagios-plugins插件" aria-label="Permalink to &quot;安装nagios-plugins插件&quot;">​</a></h2><h3 id="解压nagios-plugins源码包" tabindex="-1">解压nagios-plugins源码包 <a class="header-anchor" href="#解压nagios-plugins源码包" aria-label="Permalink to &quot;解压nagios-plugins源码包&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios httpd]# cd /software/</span></span>
<span class="line"><span>[root@nagios software]# tar zxvf nagios-plugins-2.2.1.tar.gz</span></span></code></pre></div><h3 id="进入解压后的目录进行配置" tabindex="-1">进入解压后的目录进行配置 <a class="header-anchor" href="#进入解压后的目录进行配置" aria-label="Permalink to &quot;进入解压后的目录进行配置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios software]# cd nagios-plugins-2.2.1/</span></span>
<span class="line"><span>[root@nagios nagios-plugins-2.2.1]# ./configure --with-nagios-user=nagios --with-nagios-group=nagcmd --enable-perl-modules</span></span></code></pre></div><h3 id="编译及安装" tabindex="-1">编译及安装 <a class="header-anchor" href="#编译及安装" aria-label="Permalink to &quot;编译及安装&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nagios-plugins-2.2.1]# make &amp;&amp; make install</span></span></code></pre></div><br><h2 id="安装nrpe" tabindex="-1">安装nrpe <a class="header-anchor" href="#安装nrpe" aria-label="Permalink to &quot;安装nrpe&quot;">​</a></h2><h3 id="解压nrpe源码包" tabindex="-1">解压nrpe源码包 <a class="header-anchor" href="#解压nrpe源码包" aria-label="Permalink to &quot;解压nrpe源码包&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nagios-plugins-2.2.1]# cd /software/</span></span>
<span class="line"><span>[root@nagios software]# tar zxvf nrpe-3.1.0.tar.gz</span></span></code></pre></div><h3 id="进去解压后的目录进行配置" tabindex="-1">进去解压后的目录进行配置 <a class="header-anchor" href="#进去解压后的目录进行配置" aria-label="Permalink to &quot;进去解压后的目录进行配置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios software]# cd nrpe-3.1.0/</span></span>
<span class="line"><span>[root@nagios nrpe-3.1.0]# ./configure</span></span></code></pre></div><h3 id="编译及安装-1" tabindex="-1">编译及安装 <a class="header-anchor" href="#编译及安装-1" aria-label="Permalink to &quot;编译及安装&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nrpe-3.1.0]# make all</span></span>
...
<span class="line"><span>[root@nagios nrpe-3.1.0]# cp sample-config/nrpe.cfg /usr/local/nagios/etc/nrpe.cfg</span></span></code></pre></div><h3 id="安装完成后-查看下libexec下面是否有插件" tabindex="-1">安装完成后，查看下libexec下面是否有插件 <a class="header-anchor" href="#安装完成后-查看下libexec下面是否有插件" aria-label="Permalink to &quot;安装完成后，查看下libexec下面是否有插件&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nrpe-3.1.0]# ls /usr/local/nagios/libexec/</span></span>
...
<span class="line"><span>check_file_age  check_load          check_ntp          check_simap     check_wave    utils.sh</span></span></code></pre></div><h3 id="启动nrpe-并测试服务端本地是否可以连通" tabindex="-1">启动nrpe，并测试服务端本地是否可以连通 <a class="header-anchor" href="#启动nrpe-并测试服务端本地是否可以连通" aria-label="Permalink to &quot;启动nrpe，并测试服务端本地是否可以连通&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nrpe-3.1.0]# /usr/local/nagios/bin/nrpe -d -c /usr/local/nagios/etc/nrpe.cfg </span></span>
...
<span class="line"><span>NRPE v3.1.0-rc1</span></span></code></pre></div><br>`,69),c=s(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 ~]# mkdir /software/</span></span>
...
<span class="line"><span>[root@client1 software]# wget https://sourceforge.net/projects/nagios/files/nrpe-3.x/nrpe-3.1.0.tar.gz</span></span></code></pre></div><h3 id="安装nagios-plugin" tabindex="-1">安装nagios-plugin <a class="header-anchor" href="#安装nagios-plugin" aria-label="Permalink to &quot;安装nagios-plugin&quot;">​</a></h3><p>安装依赖包</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 software]# yum install perl-devel perl-CPAN -y</span></span></code></pre></div><p>创建用户</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 software]# useradd nagios -M -s /sbin/nologin</span></span></code></pre></div><p>解压nagios-plugin源码包</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 software]# tar zxvf nagios-plugins-2.2.1.tar.gz</span></span></code></pre></div><p>进入解压后的目录进行配置</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 software]# cd nagios-plugins-2.2.1/</span></span>
<span class="line"><span>[root@client1 nagios-plugins-2.2.1]# ./configure --with-nagios-user=nagios --with-nagios-group=nagios --enable-perl-modules</span></span></code></pre></div><p>编译及安装</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 nagios-plugins-2.2.1]# make &amp;&amp; make install</span></span></code></pre></div><br><h3 id="安装nrpe插件" tabindex="-1">安装nrpe插件 <a class="header-anchor" href="#安装nrpe插件" aria-label="Permalink to &quot;安装nrpe插件&quot;">​</a></h3><p>解压nrpe源码包</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 nagios-plugins-2.2.1]# cd ..</span></span>
<span class="line"><span>[root@client1 software]# tar zxvf nrpe-3.1.0.tar.gz</span></span></code></pre></div><p>进入解压后的目录进行配置</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 software]# cd nrpe-3.1.0/</span></span>
<span class="line"><span>[root@client1 nrpe-3.1.0]# ./configure</span></span></code></pre></div><p>编译及安装</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 nrpe-3.1.0]# make all</span></span>
...
<span class="line"><span>[root@client1 nrpe-3.1.0]# cp sample-config/nrpe.cfg /usr/local/nagios/etc/nrpe.cfg</span></span></code></pre></div><p>安装完成后，查看下libexec下面是否有插件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 nrpe-3.1.0]# ls /usr/local/nagios/libexec/</span></span>
...
<span class="line"><span>check_dns       check_ifstatus      check_mysql_query  check_oracle    check_spop     check_wave</span></span></code></pre></div><p>启动nrpe，并测试服务端本地是否可以连通</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 nrpe-3.1.0]# /usr/local/nagios/bin/nrpe -d -c /usr/local/nagios/etc/nrpe.cfg </span></span>
...
<span class="line"><span>NRPE v3.1.0-rc1</span></span></code></pre></div><p>修改配置文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 nrpe-3.1.0]# cd /usr/local/nagios/etc/</span></span></code></pre></div><p>vi nrpe.cfg</p><p>允许服务端IP和本机访问，172.16.0.18是nagios服务端IP地址</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>allowed_hosts=127.0.0.1,::1    ===&gt;    修改为    allowed_hosts=127.0.0.1,::1,172.16.0.18</span></span></code></pre></div><p>注释下面几行内容</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>command[check_users]=/usr/local/nagios/libexec/check_users -w 5 -c 10</span></span>
...
<span class="line"><span>command[check_total_procs]=/usr/local/nagios/libexec/check_procs -w 150 -c 200</span></span></code></pre></div><p>在nrpe.cfg文件末尾增加下面几行内容</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># my custom monitor items</span></span>
<span class="line"><span>command[check_users]=/usr/local/nagios/libexec/check_users -w 5 -c 10</span></span>
<span class="line"><span>command[check_load]=/usr/local/nagios/libexec/check_load -r -w .15,.10,.05 -c .30,.25,.20</span></span>
...
<span class="line"><span>command[check_swap]=/usr/local/nagios/libexec/check_swap -w 20% -c 10%</span></span></code></pre></div><p>创建一个监控内存的perl脚本</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 etc]# vi /usr/local/nagios/libexec/check_mem.pl</span></span></code></pre></div><p>添加下面内容</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#! /usr/bin/perl -w</span></span>
<span class="line"><span>#</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>给脚本增加执行权限</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@client1 etc]# chmod 755 /usr/local/nagios/libexec/check_mem.pl</span></span></code></pre></div><p>重启nrpe服务</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 方法一</span></span>
...
<span class="line"><span>DISK OK - free space: / 4201 MB (24.15% inode=97%);| /=13192MB;13915;15654;0;17394</span></span></code></pre></div><br><h2 id="服务端配置" tabindex="-1">服务端配置 <a class="header-anchor" href="#服务端配置" aria-label="Permalink to &quot;服务端配置&quot;">​</a></h2><p>nrpe连接客户端机器测试是否可以连通，然后执行一个监控命令（如果不通的话可能是因为selinux和防火墙没关闭而造成的）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nrpe-3.1.0]# /usr/local/nagios/libexec/check_nrpe -H 172.16.0.20</span></span>
...
<span class="line"><span>DISK OK - free space: / 4201 MB (24.15% inode=97%);| /=13192MB;13915;15654;0;17394</span></span></code></pre></div><p>因为nagios默认把全部的权限给nagiosadmin，所以可以通过修改cgi.cfg文件赋予nagios权限，切换到/usr/local/nagios/etc目录下</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios nrpe-3.1.0]# cd /usr/local/nagios/etc</span></span>
...
<span class="line"><span>authorized_for_all_host_commands=nagiosadmin,nagios</span></span></code></pre></div><h3 id="修改nagios-cfg-自定义一些配置" tabindex="-1">修改nagios.cfg（自定义一些配置） <a class="header-anchor" href="#修改nagios-cfg-自定义一些配置" aria-label="Permalink to &quot;修改nagios.cfg（自定义一些配置）&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios etc]# vi nagios.cfg +34</span></span>
...
<span class="line"><span>cfg_file=/usr/local/nagios/etc/objects/hosts.cfg</span></span></code></pre></div><p>创建hosts.cfg和services.cfg这两个文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios etc]# cd objects/</span></span>
...
<span class="line"><span>[root@nagios objects]# chown -R nagios.nagios *</span></span></code></pre></div><p>修改nagios检查语法脚本</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios objects]# vim /etc/init.d/nagios +181</span></span>
<span class="line"><span>#check_config</span></span>
<span class="line"><span>$NagiosBin -v $NagiosCfgFile;</span></span></code></pre></div><p>vi commands.cfg 进入后按shift+g切到结尾加入下面内容。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># &#39;check_nrpe&#39; command definition</span></span>
...
<span class="line"><span>        }</span></span></code></pre></div><p>查看有哪些cfg文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios objects]# pwd</span></span>
<span class="line"><span>/usr/local/nagios/etc/objects</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span></span></span>
...
<span class="line"><span>       }</span></span></code></pre></div><p>主机组模板介绍（hosts.cfg）</p><blockquote><div class="language-# vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">#</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>define hostgroup{</span></span>
...
<span class="line"><span>       }</span></span></code></pre></div><p>主机模板配置</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios objects]# vi hosts.cfg +21</span></span>
...
<span class="line"><span>        }</span></span></code></pre></div><p>服务模板配置</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios objects]# pwd</span></span>
<span class="line"><span>/usr/local/nagios/etc/objects</span></span>
...
<span class="line"><span>        service_description     port_3306</span></span>
<span class="line"><span>        check_command           check-tcp!3306</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>重启nagios服务</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios objects]# /etc/init.d/nagios restart</span></span></code></pre></div><p>打开浏览器访问</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-48c6bd44d83c8c77.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""> 点击hosts <img src="http://upload-images.jianshu.io/upload_images/4262139-2215ddfaeae967bb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""> 点击services <img src="http://upload-images.jianshu.io/upload_images/4262139-744a741ccb47de2f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>ok，我们的配置告一段落了。</p><h3 id="出图部分" tabindex="-1">出图部分 <a class="header-anchor" href="#出图部分" aria-label="Permalink to &quot;出图部分&quot;">​</a></h3><p>下载pnp4nagios源码包</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios objects]# cd /software/</span></span>
<span class="line"><span>[root@nagios software]# wget https://jaist.dl.sourceforge.net/project/pnp4nagios/PNP-0.6/pnp4nagios-0.6.25.tar.gz</span></span></code></pre></div><p>安装依赖包</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios software]# yum install cairo pango perl-rrdtool rrdtool librrds-perl zlib zlib-devel freetype freetype-devel gd gd-devel -y</span></span></code></pre></div><p>解压pnp4nagios源码包</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios software]# tar zxf pnp4nagios-0.6.25.tar.gz</span></span></code></pre></div><p>进入解压后的目录配置png</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios pnp4nagios-0.6.25]# ./configure --with-nagios-user=nagios --with-nagios-group=nagios</span></span></code></pre></div><p>编译及安装</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios pnp4nagios-0.6.25]# make all</span></span>
...
<span class="line"><span>[root@nagios sample-config]# make install-webconf</span></span></code></pre></div><p>配置pnp4nagios</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios sample-config]# cd /usr/local/pnp4nagios/etc/</span></span>
...
<span class="line"><span>[root@nagios check_commands]# systemctl start npcd</span></span></code></pre></div><p>配置Nagios数据输出接口(以BULK模式运行)详情参考官网<a href="https://docs.pnp4nagios.org/pnp-0.6/config#bulk_mode" target="_blank" rel="noreferrer">https://docs.pnp4nagios.org/pnp-0.6/config#bulk_mode</a>：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios check_commands]# vi /usr/local/nagios/etc/nagios.cfg</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>host_perfdata_file_processing_command=process-host-perfdata-file</span></span></code></pre></div><p>配置command.cfg</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios check_commands]#  vi /usr/local/nagios/etc/objects/commands.cfg</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>在模板配置文件中添加图表图标模板：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios check_commands]# vi /usr/local/nagios/etc/objects/templates.cfg</span></span>
<span class="line"><span>在该文件中添加下面的内容</span></span>
<span class="line"><span></span></span>
<span class="line"><span>define host {</span></span>
...
<span class="line"><span>  register  0</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>在监控主机和服务中调用图表模板（在主机和服务后面添加新的模板）：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios check_commands]# vi /usr/local/nagios/etc/objects/hosts.cfg </span></span>
...
<span class="line"><span>        service_description     port_3306</span></span>
<span class="line"><span>        check_command           check-tcp!3306</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>图表展示 重启nagios和apache</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios check_commands]# /etc/init.d/nagios checkconfig </span></span>
<span class="line"><span>[root@nagios check_commands]# /etc/init.d/nagios restart</span></span>
<span class="line"><span>[root@nagios check_commands]# systemctl restart httpd</span></span></code></pre></div><p>访问nagios界面即可看到图表小图标： <img src="http://upload-images.jianshu.io/upload_images/4262139-8fbb2305b200d1e1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>点击图标会显示pnp4nagios测试页面： <img src="http://upload-images.jianshu.io/upload_images/4262139-379c19ab095d7158.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""> 全是绿色代表配置正常，如果不是全绿，要逐个解决错误。然后移除或修改install.php文件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ~]# rm -rf /usr/local/pnp4nagios/share/install.php</span></span></code></pre></div><p>再次点击图标就会显示当前监控服务由pnp4nagios生成的图表了 <img src="http://upload-images.jianshu.io/upload_images/4262139-fc64d86803601200.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><h3 id="邮件报警配置" tabindex="-1">邮件报警配置 <a class="header-anchor" href="#邮件报警配置" aria-label="Permalink to &quot;邮件报警配置&quot;">​</a></h3><p>查看sendmail邮件系统是否安装</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ~]# rpm -qa|grep sendmail</span></span></code></pre></div><p>如果没有安装，可以yum安装一下</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ~]# yum -y install sendmail</span></span></code></pre></div><p>启动sendmail</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ~]# systemctl enable sendmail</span></span>
<span class="line"><span>[root@nagios ~]# systemctl start sendmail</span></span></code></pre></div><p>测试发送邮件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ~]# echo &quot;test&quot; | mail zhengxinlei@test.com.cn</span></span></code></pre></div><p><img src="http://upload-images.jianshu.io/upload_images/4262139-0ccf4d2004d88b80.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>发送外部邮件的时候，这种本地形式的发件人和发件地址容易被误认为垃圾邮件而拒收。 我们这里定义邮件发送smtp信息。 首先安装mailx12.5</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>wget http://fossies.org/linux/misc/old/mailx-12.5.tar.gz</span></span>
...
<span class="line"><span>mail -V</span></span></code></pre></div><p>接下来配置外部smtp发件信息</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>vi /etc/nail.rc </span></span>
...
<span class="line"><span>set smtp-auth=login</span></span></code></pre></div><p>测试邮件发送</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>echo &#39;mail content&#39;|mail -s test zhengxinlei@test.com.cn</span></span></code></pre></div><p>发送邮件测试，可以看到发件人是我们设定的外部邮件发件人 <img src="http://upload-images.jianshu.io/upload_images/4262139-15e57a5da967985f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>编辑contacts.cfg，定义邮件联系人和组</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ~]# cd /usr/local/nagios/etc/objects/</span></span>
...
<span class="line"><span>        }</span></span></code></pre></div><p>编辑commands.cfg文件，定义邮件发送命令</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios objects]# vi commands.cfg                // 查看下面内容是否存在，不存在则添加</span></span>
...
<span class="line"><span>　　}</span></span></code></pre></div><p>修改一下监控的阀值，模拟报警。 <img src="http://upload-images.jianshu.io/upload_images/4262139-0f50ab0e3ef5c1ac.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""> 重启nagios服务和sendmail服务</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ~]# systemctl restart nagios</span></span>
...
<span class="line"><span>/usr/local/nagios/libexec/check_nrpe -H localhost -c check_disk</span></span></code></pre></div><p><strong>总结：</strong> 多多查看nagios日志和mail日志，进行排错。</p>`,8);function o(r,g,d,h,u,m){return p(),e("div",null,[l,n(" *** ## nagios客户端的安装 ### 下载nagios-plugin和nrpe插件 "),c,n(" *** 报错2（发送外部邮件的时候，这种本地形式的发件人和发件地址容易被误认为垃圾邮件而拒收。） ![](http://upload-images.jianshu.io/upload_images/4262139-60dbb010c9f05c1d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240) 解决方法，见上面配置mail发件人smtp信息。 "),t])}const k=a(i,[["render",o]]);export{b as __pageData,k as default};
