import{_ as s,o as n,c as a,V as p}from"./chunks/framework.02f07c5e.js";const m=JSON.parse('{"title":"Centos-7系统优化脚本","description":"","frontmatter":{"title":"Centos-7系统优化脚本","tags":["Centos","Linux"],"categories":["Linux"]},"headers":[],"relativePath":"Linux/Centos-7系统优化脚本.md","filePath":"Linux/Centos-7系统优化脚本.md","lastUpdated":1625641181000}'),l={name:"Linux/Centos-7系统优化脚本.md"},o=p(`<h3 id="脚本如下-后续继续优化" tabindex="-1">脚本如下，后续继续优化</h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#!/bin/bash</span></span>
