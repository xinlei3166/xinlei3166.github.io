import{_ as s,c as i,o as a,ag as n}from"./chunks/framework.CgtRPpXH.js";const y=JSON.parse('{"title":"Centos-7系统优化脚本","description":"","frontmatter":{"title":"Centos-7系统优化脚本","tags":["Centos","Linux"],"categories":["Linux"]},"headers":[],"relativePath":"blog/Linux/Centos-7系统优化脚本.md","filePath":"blog/Linux/Centos-7系统优化脚本.md","lastUpdated":1778156131000}'),l={name:"blog/Linux/Centos-7系统优化脚本.md"},p=n(`<h3 id="脚本如下-后续继续优化" tabindex="-1">脚本如下，后续继续优化 <a class="header-anchor" href="#脚本如下-后续继续优化" aria-label="Permalink to &quot;脚本如下，后续继续优化&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#!/bin/bash</span></span>
