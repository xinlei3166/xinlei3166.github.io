import{_ as s,v as n,b as a,R as l}from"./chunks/framework.780d3f64.js";const C=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"JavaScript/element-ui 日期选择器-自定义前缀文本信息.md","filePath":"JavaScript/element-ui 日期选择器-自定义前缀文本信息.md","lastUpdated":1625641181000}'),p={name:"JavaScript/element-ui 日期选择器-自定义前缀文本信息.md"},o=l(`<p><strong>自定义less类名：</strong></p><div class="language-less vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">less</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/* 日期选择器-自定义前缀文本信息 */</span></span>
