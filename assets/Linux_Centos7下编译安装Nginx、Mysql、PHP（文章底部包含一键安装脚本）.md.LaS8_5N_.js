...
<span class="line"><span>[root@localhost software]# sh one-click-install-lnmp.sh</span></span></code></pre></div><p>等待安装完成即可。</p>`,96);function c(o,r,d,h,m,g){return e(),n("div",null,[i,p(" ## 安装MySQL ### 安装依赖包 "),t])}const y=a(l,[["render",c]]);export{b as __pageData,y as default};
