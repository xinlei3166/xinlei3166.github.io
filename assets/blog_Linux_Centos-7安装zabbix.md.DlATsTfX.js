import{_ as n,c as i,a,ag as s,o as p}from"./chunks/framework.CgtRPpXH.js";const F=JSON.parse('{"title":"Centos-7安装zabbix","description":"","frontmatter":{"title":"Centos-7安装zabbix","tags":["Centos","Linux","Zabbix","监控"],"categories":["Linux"]},"headers":[],"relativePath":"blog/Linux/Centos-7安装zabbix.md","filePath":"blog/Linux/Centos-7安装zabbix.md","lastUpdated":1733335015000}'),l={name:"blog/Linux/Centos-7安装zabbix.md"},e=s(`<h2 id="本例环境使用centos7-3-64位" tabindex="-1">本例环境使用Centos7.3 64位 <a class="header-anchor" href="#本例环境使用centos7-3-64位" aria-label="Permalink to &quot;本例环境使用Centos7.3 64位&quot;">​</a></h2><p><strong>安装zabbix需要mysql的支持，下面是快速安装LNMP的方法（使用EZHTTP安装）</strong></p><h2 id="安装lnmp" tabindex="-1">安装LNMP <a class="header-anchor" href="#安装lnmp" aria-label="Permalink to &quot;安装LNMP&quot;">​</a></h2><p><strong>首先创建一个目录存放下载文件：</strong></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">~</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]# mkdir /software</span></span>
