import{_ as n,o as a,c as e,a as l,V as s}from"./chunks/framework.02f07c5e.js";const m=JSON.parse('{"title":"Centos-7下saltstack安装配置详解","description":"","frontmatter":{"title":"Centos-7下saltstack安装配置详解","tags":["Centos","Linux","自动化运维","Saltstack"],"categories":["Linux"]},"headers":[],"relativePath":"Linux/Centos-7下saltstack安装配置详解.md","filePath":"Linux/Centos-7下saltstack安装配置详解.md","lastUpdated":1625641181000}'),p={name:"Linux/Centos-7下saltstack安装配置详解.md"},o=s(`<h1 id="简述" tabindex="-1">简述</h1><blockquote><p><strong>saltstack</strong></p></blockquote><ul><li><p>saltstack是一个新的基础平台管理工具，只需要花费数分钟即可运行起来，可以支撑管理上万台服务器的规模，数秒钟即可完成数据传递。</p></li><li><p>saltstack是使用python语言开发的，同时也支持restAPI方便二次开发以及和它平台集成，同时官方也发布了一个Web管理界面halite。</p></li></ul><blockquote><p><strong>优点：</strong></p></blockquote><ul><li>首先，他速度快，基于消息队列+线程，跑完多台设备，都是毫秒级别的</li><li>其次，非常灵活，源码是python，方便理解和自定义模块（python 语言相对于其他的perl、ruby等还是很好理解的）</li><li>命令简单，功能强大</li></ul><blockquote><p><strong>saltstack运行方式</strong></p></blockquote><ul><li>Local</li><li>Master/Minion</li><li>Salt SSH</li></ul><p>本文使用Master/Minion运行方式。</p><blockquote><p><strong>saltstack三大功能</strong></p></blockquote><ul><li>远程执行</li><li>配置管理</li><li>云管理</li></ul><blockquote><p><strong>saltstack数据系统</strong></p><ul><li>Grains （静态数据）</li><li>pillar （动态数据）</li></ul></blockquote><blockquote><p><strong>saltstack配置管理</strong></p></blockquote><ul><li>SLS（YAML、Jinja）</li><li>Highstate</li><li>States Module</li></ul><h1 id="实现环境" tabindex="-1">实现环境</h1><p>准备三台机器，这三台机器都关闭 selinux，清空防火墙规则。</p><blockquote><ul><li>saltstack ==&gt; 172.16.0.19 （服务端）</li><li>client1 ==&gt; 172.16.0.20 （客户端）</li><li>client2 ==&gt; 172.16.0.21 （客户端）</li></ul></blockquote><p>查看版本和内核</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# cat /etc/redhat-release</span></span>
...
<span class="line"><span style="color:#24292e;">172.16.0.21 client2</span></span></code></pre></div><h1 id="开始安装" tabindex="-1">开始安装</h1><p>分别为三台机器添加阿里云epel源</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# mv /etc/yum.repos.d/epel.repo /etc/yum.repos.d/epel.repo.backup</span></span>
...
<span class="line"><span style="color:#24292e;">[root@client1 ~]# systemctl start salt-minion</span></span></code></pre></div><h1 id="配置认证" tabindex="-1">配置认证</h1><p>服务端操作</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# salt-key -a client1</span></span>
...
<span class="line"><span style="color:#24292e;">[root@saltstack ~]# salt &#39;client1&#39; grains.items    // 列出所有的 grains 项目名以及值</span></span></code></pre></div><p>grains的信息并不是动态的，并不会时时变更，它只是在 minion 启动时收集到的。grains 也可以做配置管理</p><p>自定义 grains的方法有两种（客户端自定义配置和服务端写脚本定义）：</p><h3 id="_1-客户端配置" tabindex="-1">1.客户端配置</h3><p>缺点：每台都得去配置，机器多了配置起来不方便</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@client1 ~]# vi /etc/salt/grains     // 添加如下，注意冒号后有空格</span></span>
...
<span class="line"><span style="color:#24292e;">    client2</span></span>
<span class="line"><span style="color:#24292e;">client1:</span></span>
<span class="line"><span style="color:#24292e;">    client1</span></span></code></pre></div><h3 id="_2-服务端写python脚本" tabindex="-1">2.服务端写Python脚本</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# mkdir /srv/salt/_grains</span></span>
...
<span class="line"><span style="color:#24292e;">            Centos-Linux</span></span></code></pre></div><h1 id="配置管理安装apache" tabindex="-1">配置管理安装Apache</h1><p>下面进行的演示是远程通过 yum 方式安装 Apache。步骤如下： 修改配置文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# vi /etc/salt/master +406    // 打开如下内容的注释</span></span>
...
<span class="line"><span style="color:#24292e;">saltstack ....</span></span>
<span class="line"><span style="color:#24292e;">this is a test ...</span></span></code></pre></div><h2 id="_2、目录管理" tabindex="-1">2、目录管理</h2><p>服务端配置 接着编辑/srv/salt/目录下的top.sls 文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# vi /srv/salt/top.sls     // 修改为如下</span></span>
<span class="line"><span style="color:#e1e4e8;">base:</span></span>
<span class="line"><span style="color:#e1e4e8;">  &#39;client1&#39;:</span></span>
...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">1 directory, 2 files</span></span></code></pre></div><p>注意：由上图可知，成功在客户端 /tmp/testdir/ 目录下创建了 mydir 目录以及 testdir.add 文件，并删除 2.txt 文件。这里值得注意的是要成功创建 mydir 目录，前提是 mydir 目录下要有文件，如这里的111.txt 文件，如若没有，客户端是不会创建 mydir 目录的。</p><h1 id="远程执行" tabindex="-1">远程执行</h1><p>前面提到远程执行命令 test.ping，cmd.run，点前面的是模块，点后面的是函数；这样总归是不太规范化，下面详细介绍怎么远程执行命令和脚本。</p><h2 id="_1、远程执行命令" tabindex="-1">1、远程执行命令</h2><p>服务端配置 接着编辑/srv/salt/目录下的top.sls 文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# vi /srv/salt/top.sls     // 修改为如下</span></span>
<span class="line"><span style="color:#e1e4e8;">base:</span></span>
<span class="line"><span style="color:#e1e4e8;">  &#39;client1&#39;:</span></span>
...
<span class="line"><span style="color:#24292e;">drwxr-xr-x  3 root  root     38 4月  26 11:14 testdir</span></span></code></pre></div><h2 id="_2、远程执行脚本" tabindex="-1">2、远程执行脚本</h2><p>服务端配置 接着编辑/srv/salt/目录下的top.sls 文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# vi /srv/salt/top.sls    // 修改为如下</span></span>
<span class="line"><span style="color:#e1e4e8;">base:</span></span>
<span class="line"><span style="color:#e1e4e8;">  &#39;client1&#39;:</span></span>
...
<span class="line"><span style="color:#24292e;">-rw-r--r--  1 root  root      0 4月  26 12:08 shelltest.txt</span></span></code></pre></div><p>通过上面的例子，我们实现了远程执行脚本；如果我们想一键远程安装 LAMP 或者 LNMP，那么只需把本例中的 1.sh 脚本替换成 一键安装的脚本就行。</p><h1 id="管理任务计划" tabindex="-1">管理任务计划</h1><h2 id="_1、建立-cron" tabindex="-1">1、建立 cron</h2><p>服务端配置 编辑/srv/salt/目录下的top.sls 文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# vi /srv/salt/top.sls     // 修改为如下</span></span>
<span class="line"><span style="color:#e1e4e8;">#base:</span></span>
<span class="line"><span style="color:#e1e4e8;">#  &#39;client1&#39;:</span></span>
<span class="line"><span style="color:#e1e4e8;">#    - apache</span></span>
<span class="line"><span style="color:#e1e4e8;">#base:</span></span>
...
<span class="line"><span style="color:#24292e;">* 20 1-10 3,5 * /bin/touch /tmp/111.txt</span></span></code></pre></div><h2 id="_2、删除-cron" tabindex="-1">2、删除 cron</h2><p>服务端配置 我们只需修改 crontest.sls 文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# vim /srv/salt/crontest.sls</span></span>
...
<span class="line"><span style="color:#24292e;">this msg from new install rsync client used by test</span></span></code></pre></div><p>好的，顺利装完，出去抽支烟和活动下颈椎吧。</p><h1 id="saltstack-常用命令" tabindex="-1">Saltstack 常用命令</h1><h2 id="_1、拷贝文件到客户端" tabindex="-1">1、拷贝文件到客户端</h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# salt &#39;client2&#39; cp.get_file salt://apache.sls /tmp/cp.txt</span></span>
<span class="line"><span style="color:#e1e4e8;">client2:</span></span>
...
<span class="line"><span style="color:#24292e;">总用量 4</span></span>
<span class="line"><span style="color:#24292e;">-rw-r--r-- 1 root root 151 4月  26 14:04 cp.txt</span></span></code></pre></div><h2 id="_2、拷贝目录到客户端" tabindex="-1">2、拷贝目录到客户端</h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# salt &#39;client2&#39; cp.get_dir salt://test /tmp</span></span>
<span class="line"><span style="color:#e1e4e8;">client2:</span></span>
...
<span class="line"><span style="color:#24292e;">drwxr-xr-x 3 root root  29 4月  26 14:14 test</span></span></code></pre></div><h2 id="_3、显示存活的客户端" tabindex="-1">3、显示存活的客户端</h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# salt-run manage.up</span></span>
<span class="line"><span style="color:#e1e4e8;">- client1</span></span>
<span class="line"><span style="color:#e1e4e8;">- client2</span></span>
...
<span class="line"><span style="color:#24292e;">- client1</span></span>
<span class="line"><span style="color:#24292e;">- client2</span></span>
<span class="line"><span style="color:#24292e;">- saltstack</span></span></code></pre></div><h2 id="_4、命令下执行服务端的脚本" tabindex="-1">4、命令下执行服务端的脚本</h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@saltstack ~]# vim /srv/salt/test/shell.sh</span></span>
<span class="line"><span style="color:#e1e4e8;">#! /bin/sh</span></span>
