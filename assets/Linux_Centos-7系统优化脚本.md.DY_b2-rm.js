import{_ as s,o as i,c as a,ag as n}from"./chunks/framework.BwfKdYSM.js";const y=JSON.parse('{"title":"Centos-7系统优化脚本","description":"","frontmatter":{"title":"Centos-7系统优化脚本","tags":["Centos","Linux"],"categories":["Linux"]},"headers":[],"relativePath":"Linux/Centos-7系统优化脚本.md","filePath":"Linux/Centos-7系统优化脚本.md","lastUpdated":1625641181000}'),p={name:"Linux/Centos-7系统优化脚本.md"},l=n(`<h3 id="脚本如下-后续继续优化" tabindex="-1">脚本如下，后续继续优化 <a class="header-anchor" href="#脚本如下-后续继续优化" aria-label="Permalink to &quot;脚本如下，后续继续优化&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#!/bin/bash</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">+-------------------------------------------------+</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">EOF</span></span></code></pre></div>`,2),t=[l];function h(k,e,F,r,d,c){return i(),a("div",null,t)}const C=s(p,[["render",h]]);export{y as __pageData,C as default};
