import{_ as s,o as a,c as p,av as i}from"./chunks/framework.B5CsnGBr.js";const o=JSON.parse('{"title":"php添加扩展库","description":"","frontmatter":{"title":"php添加扩展库","tags":["Linux","PHP"],"categories":["Linux"]},"headers":[],"relativePath":"blog/Linux/php添加扩展库.md","filePath":"blog/Linux/php添加扩展库.md","lastUpdated":1778156131000}'),x={name:"blog/Linux/php添加扩展库.md"};function r(l,n,e,u,c,t){return a(),p("div",null,[...n[0]||(n[0]=[i(`<h2 id="首先进入解压后的php源码包目录" tabindex="-1">首先进入解压后的php源码包目录 <a class="header-anchor" href="#首先进入解压后的php源码包目录" aria-label="Permalink to &quot;首先进入解压后的php源码包目录&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[root@nagios ~]# cd /software/php-7.1.4/</span></span>
