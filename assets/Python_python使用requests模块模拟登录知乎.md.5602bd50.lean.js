import{_ as s,v as n,b as a,R as p}from"./chunks/framework.780d3f64.js";const h=JSON.parse('{"title":"python使用requests模块模拟登录知乎","description":"","frontmatter":{"title":"python使用requests模块模拟登录知乎","tags":["Python","requests"],"categories":["Python"]},"headers":[],"relativePath":"Python/python使用requests模块模拟登录知乎.md","filePath":"Python/python使用requests模块模拟登录知乎.md","lastUpdated":1625641181000}'),l={name:"Python/python使用requests模块模拟登录知乎.md"},o=p(`<p><strong>requests模块更多使用方法请看<a href="http://cn.python-requests.org/zh_CN/latest/user/advanced.html#advanced" target="_blank" rel="noreferrer">官方文档</a>。</strong></p><h5 id="模拟登录代码如下" tabindex="-1">模拟登录代码如下： <a class="header-anchor" href="#模拟登录代码如下" aria-label="Permalink to &quot;模拟登录代码如下：&quot;">​</a></h5><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#!/usr/bin/env python</span></span>
