import{_ as n,o as i,c as p,a,ag as s}from"./chunks/framework.BwfKdYSM.js";const F=JSON.parse('{"title":"Centos-7安装zabbix","description":"","frontmatter":{"title":"Centos-7安装zabbix","tags":["Centos","Linux","Zabbix","监控"],"categories":["Linux"]},"headers":[],"relativePath":"Linux/Centos-7安装zabbix.md","filePath":"Linux/Centos-7安装zabbix.md","lastUpdated":1625641181000}'),l={name:"Linux/Centos-7安装zabbix.md"},e=s(`<h2 id="本例环境使用centos7-3-64位" tabindex="-1">本例环境使用Centos7.3 64位 <a class="header-anchor" href="#本例环境使用centos7-3-64位" aria-label="Permalink to &quot;本例环境使用Centos7.3 64位&quot;">​</a></h2><p><strong>安装zabbix需要mysql的支持，下面是快速安装LNMP的方法（使用EZHTTP安装）</strong></p><h2 id="安装lnmp" tabindex="-1">安装LNMP <a class="header-anchor" href="#安装lnmp" aria-label="Permalink to &quot;安装LNMP&quot;">​</a></h2><p><strong>首先创建一个目录存放下载文件：</strong></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">~</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]# mkdir /software</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost software]# cd /software/</span></span></code></pre></div><p><strong>安装wget工具：</strong></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost software]# yum -y install wget</span></span></code></pre></div><p><strong>下载EZHTTP安装脚本：</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# wget --no-check-certificate https://github.com/centos-bz/ezhttp/archive/master.zip?time=$(date +%s) -O ezhttp.zip</span></span></code></pre></div><p><strong>启动脚本：</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# unzip ezhttp.zip</span></span>
...
<span class="line"><span>[root@localhost ezhttp-master]# ./start.sh</span></span></code></pre></div><p><strong>进去选择页面</strong></p><p><strong>除了数字选择项需要确认输入，其他的的按回车默认就行：</strong></p><p>nginx 和 apache 都行，个人比较喜欢nginx php版本5.5-7.1 mysql版本5.6</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost ezhttp-master]# ./start.sh</span></span>
...
<span class="line"><span>##############################################################</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Are you ready to configure your Linux?[Y/n](default y):</span></span></code></pre></div><p>安装过程等待即可：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>..............................</span></span>
<span class="line"><span>..............................</span></span></code></pre></div><p>安装成功：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> programs...</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">Starting</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> Redis</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> server...</span></span></code></pre></div><p><strong>使用EZHTTP安装成功后各服务已经打开，输入Linxu 机器IP 访问即可：</strong></p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-1fdd923b81b5872f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""> 恭喜，安装成功了！</p><br>`,22),t=s(`<h3 id="配置源" tabindex="-1">配置源 <a class="header-anchor" href="#配置源" aria-label="Permalink to &quot;配置源&quot;">​</a></h3><p>Zabbix在CentOS基本源里不可获得，因此必须配置EPEL 和Zabbix 官方repository，因为需要一款名叫fping的软件（这款软件你下载源码编译安装貌似行不通！），然后其他的yum源将mysql全部识别为mariadb了，所以想yum安装mysql，请安装mysql社区版官方源，或者编译安装，上面的EZHTTP安装脚本就是编译安装</p><p>安装EPEL repository</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# pwd</span></span>
<span class="line"><span>/software</span></span>
<span class="line"><span>[root@localhost software]# yum -y install epel-release</span></span></code></pre></div><p>配置ZabbixZone package repository and GPG key</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# rpm --import http://repo.zabbix.com/RPM-GPG-KEY-ZABBIX</span></span>
...
<span class="line"><span>[root@localhost software]# rpm -ivh http://repo.zabbix.com/zabbix/3.2/rhel/7/x86_64/zabbix-release-3.2-1.el7.noarch.rpm</span></span></code></pre></div><h3 id="安装zabbix-server-and-agent-agent是可选的" tabindex="-1">安装Zabbix server and agent（agent是可选的） <a class="header-anchor" href="#安装zabbix-server-and-agent-agent是可选的" aria-label="Permalink to &quot;安装Zabbix server and agent（agent是可选的）&quot;">​</a></h3><p>安装Zabbix server and agent:（配置自己监控自己，所以安装了zabbix-agent）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>yum -y install zabbix-server-mysql zabbix-web-mysql zabbix-agent</span></span></code></pre></div><p><strong>可以上zabbix rpm包官网查看或下载相应包</strong></p><p><a href="http://repo.zabbix.com/" target="_blank" rel="noreferrer">http://repo.zabbix.com/</a></p><h3 id="创建mysql-数据库和用户" tabindex="-1">创建MySQL 数据库和用户 <a class="header-anchor" href="#创建mysql-数据库和用户" aria-label="Permalink to &quot;创建MySQL 数据库和用户&quot;">​</a></h3><p>登录Mysql：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# mysql -uroot -p123456</span></span></code></pre></div><p>创建一个数据库zabbix和数据库用户zabbix：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">mysql&gt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> create</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> database</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> zabbix</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> character</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> set</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> utf8</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">mysql&gt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> grant</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> all</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> privileges</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> on</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> zabbix.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">*</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> to</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;zabbix&#39;@&#39;localhost&#39;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> identified</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> by</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;zabbix&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">mysql&gt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> flush</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> privileges</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div><h3 id="数据库导入zabbix-template" tabindex="-1">数据库导入zabbix template <a class="header-anchor" href="#数据库导入zabbix-template" aria-label="Permalink to &quot;数据库导入zabbix template&quot;">​</a></h3><p>看yum安装的zabbix-server-mysql-3.x.x 这个文件的版本是多少就改成多少</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# zcat /usr/share/doc/zabbix-server-mysql-3.2.4/create.sql.gz |mysql -uzabbix -pzabbix -b zabbix</span></span></code></pre></div><h3 id="配置zabbix-server" tabindex="-1">配置Zabbix server <a class="header-anchor" href="#配置zabbix-server" aria-label="Permalink to &quot;配置Zabbix server&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>vi /etc/zabbix/zabbix_server.conf</span></span></code></pre></div><p>配置下面的几个参数 带#号的就去掉#号，并修改其值</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ListenPort=10051</span></span>
...
<span class="line"><span>DBPort=3306</span></span></code></pre></div><h3 id="配置zabbix-agent" tabindex="-1">配置zabbix-agent <a class="header-anchor" href="#配置zabbix-agent" aria-label="Permalink to &quot;配置zabbix-agent&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>vi /etc/zabbix/zabbix_agentd.conf</span></span></code></pre></div><p>配置zabbix server的ip</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">## Line 95 - Specify Zabbix server ##</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Server</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">127.0.0.1</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">## Line 136 - Specify Zabbix server ##</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ServerActive</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">127.0.0.1</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Hostname</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">127.0.0.1</span></span></code></pre></div><h3 id="修改php-设置" tabindex="-1">修改PHP 设置 <a class="header-anchor" href="#修改php-设置" aria-label="Permalink to &quot;修改PHP 设置&quot;">​</a></h3><p>修改php.ini为zabbix 建议的设置 编辑文件 php.ini,</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# vi /usr/local/php/etc/php.ini</span></span></code></pre></div><p>设置下面的参数：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">max_execution_time</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> =</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 300</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">date.timezone</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> =</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> Asia/Shanghai</span></span></code></pre></div><p>安装时可能缺少下面扩展，把下面内容添加到php.ini</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>extension=bcmath.so</span></span>
<span class="line"><span>extension=gettext.so</span></span>
<span class="line"><span>extension=sockets.so</span></span></code></pre></div><p>安装扩展</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost ext]# cd /software/ezhttp-master/soft/php-7.1.0/ext</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost sockets]# ./configure --with-php-config=/usr/local/php/bin/php-config</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost bcmath]# ./configure --with-php-config=/usr/local/php/bin/php-config</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost gettext]# ./configure --with-php-config=/usr/local/php/bin/php-config</span></span></code></pre></div><p>使用下面命令可以看到有一个扩展存放的目录，我们需要的扩展模块在其中即安装成功</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost gettext]# make &amp;&amp; make install</span></span></code></pre></div><p>修改php-fpm运行的用户和组</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# vi /usr/local/php/etc/php-fpm.d/www.conf</span></span>
<span class="line"><span>user = www</span></span>
<span class="line"><span>group = www</span></span></code></pre></div><h3 id="方法一-使用-apache-服务器" tabindex="-1">方法一：使用 apache 服务器 <a class="header-anchor" href="#方法一-使用-apache-服务器" aria-label="Permalink to &quot;方法一：使用 apache 服务器&quot;">​</a></h3><p>apache配置zabbix-web站点文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost etc]# cd /etc/httpd/</span></span></code></pre></div><p>vi conf/httpd.conf 修改下面内容：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">Listen</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 80</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&lt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">/IfModule</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span></span></code></pre></div><p>vi conf.d/zabbix.conf 修改内容如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;IfModule mod_php5.c&gt;</span></span>
...
<span class="line"><span>&lt;/IfModule&gt;</span></span></code></pre></div><p>然后重启apache、mysql、php、zabbix-server 浏览器输入ip/setup.php 即可进入zabbix初次web安装界面</p><h3 id="方法二-使用-nginx-服务器" tabindex="-1">方法二：使用 Nginx 服务器 <a class="header-anchor" href="#方法二-使用-nginx-服务器" aria-label="Permalink to &quot;方法二：使用 Nginx 服务器&quot;">​</a></h3><p>配置zabbix-web站点文件</p><p>把zabbix程序文件拷贝到我们指定的目录，并修改属主和属组</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost software]# cp -r /usr/share/zabbix /var/www/</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root@localhost software]# chmod -R 755 /etc/zabbix/web</span></span></code></pre></div><p>创建存放web站点配置文件的目录</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost ~]# cd /usr/local/nginx/conf/</span></span>
<span class="line"><span>[root@localhost conf]# mkdir conf.d/</span></span></code></pre></div><p>配置nginx.conf，把新建的目录包含进去</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost conf]# vi nginx.conf</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>include vhost/*.conf;    ===&gt; 改为 include /usr/local/nginx/conf/conf.d/*.conf;</span></span></code></pre></div><p>配置zabbix.conf（zabiix站点的配置文件）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost conf]# cd conf.d/</span></span>
<span class="line"><span>[root@localhost conf.d]# vi zabbix.conf</span></span></code></pre></div><p>zabbix.conf 内容如下:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    server</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> {</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">systemctl</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> enable</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> zabbix-agent</span></span></code></pre></div><h3 id="修改firewall-和selinux-设置" tabindex="-1">修改Firewall 和SELinux 设置 <a class="header-anchor" href="#修改firewall-和selinux-设置" aria-label="Permalink to &quot;修改Firewall 和SELinux 设置&quot;">​</a></h3><p>开放zabbix端口10050 and 10051</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>firewall-cmd --permanent --add-port=10050/tcp</span></span>
<span class="line"><span></span></span>
<span class="line"><span>firewall-cmd --permanent --add-port=10051/tcp</span></span></code></pre></div><p>重启firewall</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>systemctl restart firewalld</span></span></code></pre></div><p>如果使用 SELinux, 运行以下命令使 Apache 可以和 Zabbix通信</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>setsebool -P httpd_can_connect_zabbix=1</span></span></code></pre></div><p>如果是测试环境可以直接关闭防火墙和selinux</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# systemctl stop firewalld</span></span>
<span class="line"><span>[root@localhost local]# chkconfig firewalld off</span></span></code></pre></div><p>修改配置文件，禁用selinux</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@localhost software]# setenforce 0</span></span>
<span class="line"><span>[root@localhost software]# vi /etc/selinux/config</span></span>
<span class="line"><span></span></span>
<span class="line"><span>SELINUX=disabled</span></span></code></pre></div><h3 id="输入ip-setup-php进入zabbix-web界面进行后续安装操作" tabindex="-1">输入ip/setup.php进入zabbix-web界面进行后续安装操作 <a class="header-anchor" href="#输入ip-setup-php进入zabbix-web界面进行后续安装操作" aria-label="Permalink to &quot;输入ip/setup.php进入zabbix-web界面进行后续安装操作&quot;">​</a></h3><p><img src="http://upload-images.jianshu.io/upload_images/4262139-db8ffdf58139d8de.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>确认状态都是ok</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-3fc40c17e9fc0c71.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>配置数据库信息（填写上面我们设置的数据库账户和密码：zabbix，zabbix，测试环境可以直接用root）</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-52a9f1f89aea0cd1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>进入下一步，默认即可</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-d4824356ff2cb9b0.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>如果出现下面错误</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-ff60edcaf0e32bcb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""> 解决方法：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>sed -i &#39;s#cgi.fix_pathinfo=0#cgi.fix_pathinfo=1#&#39; /usr/local/php/etc/php.ini</span></span>
<span class="line"><span>/etc/init.d/php-fpm restart</span></span></code></pre></div><p>刷新浏览器， 一直下一步</p><p>登录，默认用户名: Admin , 默认密码：zabbix</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-8b105d93769010dd.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>使用php7.0版本初始化完成后页面有如下的报错：</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-4d9f12c8d410218c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>这个是因为PHP 7.1.0类型强化，处理方法也很简单找到Zabbix WEB目录下include/func.inc.php文件，执行下面命令，并重启php服务：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sed</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -i</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;/$last = strtolower(substr($val, -1));/a$val = substr($val,0,-1);&#39;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /var/www/zabbix/include/func.inc.php</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/etc/init.d/php-fpm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> reload</span></span></code></pre></div><p>然后刷新页面可以看到已经正常。</p><p>ok，初始化完毕。。。</p><br>`,95),h=s(`<p><img src="http://upload-images.jianshu.io/upload_images/4262139-0fe91cab9756e860.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""> 这个问题是由于zabbix的web端没有中文字库，我们最需要把中文字库加上即可 解决办法如下 1.从windows下控制面板-&gt;字体-&gt;选择一种中文字库例如“楷体”</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-bc6dd0f78aacd666.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>2.把它拷贝到zabbix的web端的fonts目录下例如：/var/www/html/zabbix/fonts，确认后缀为ttf <img src="http://upload-images.jianshu.io/upload_images/4262139-e728c83852df078a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""> 3.修改zabbix的web端/include/defines.inc.php 点击(此处)折叠或打开</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">//define(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">&#39;ZBX_FONT_NAME&#39;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">,</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;graphfont&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">define(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">&#39;ZBX_GRAPH_FONT_NAME&#39;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">,</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">       &#39;simkai&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">); </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">//</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> font</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> file</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> name</span></span></code></pre></div><p>其中simkai为字库名字,不包含ttf后缀 测试结果：</p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-87a0a189fda1b313.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p>`,6);function o(c,r,d,k,g,u){return i(),p("div",null,[e,a(" ## 开始安装zabbix "),t,a(" ## 解决图形中文乱码 "),h])}const y=n(l,[["render",o]]);export{F as __pageData,y as default};
