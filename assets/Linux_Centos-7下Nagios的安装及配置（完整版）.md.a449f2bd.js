import{_ as a,o as e,c as p,a as n,V as s}from"./chunks/framework.02f07c5e.js";const _=JSON.parse('{"title":"Centos-7下Nagios的安装及配置（完整版）","description":"","frontmatter":{"title":"Centos-7下Nagios的安装及配置（完整版）","tags":["Centos","Linux","Nagios","监控"],"categories":["Linux"]},"headers":[],"relativePath":"Linux/Centos-7下Nagios的安装及配置（完整版）.md","filePath":"Linux/Centos-7下Nagios的安装及配置（完整版）.md","lastUpdated":1625641181000}'),l={name:"Linux/Centos-7下Nagios的安装及配置（完整版）.md"},o=s(`<h2 id="简介" tabindex="-1">简介</h2><p>Nagios 是一款自动化运维工具，可以协助运维人员监控服务器的运行状况，并且拥有报警功能。本文章将介绍其安装方法和详细的配置方法。</p><blockquote><p><strong>nagios 监控服务应用指南</strong> 本地资源：负载，CPU，磁盘，内存。IO，RAID，温度，passwd文件变化，本地所有文件指纹识别 网络服务：端口，URL，丢包，进程，网络流量 其他设备：交换机，打印机，windows等。 业务数据：用户登录失败次数，用户登录网站次数，输入验证码失败的次数，某个API接口流量并发，电商网站订单，支付交易的数量</p></blockquote><blockquote><p>nagios成员：主程序nagios，插件nagios-plugins，和一些可选的客户端nrpe，NSClient++,NSCA和NDOUtils</p></blockquote><blockquote><ul><li>NRPE--半被动模式 存放位置：安装在客户端 NRPE作用：在客户端执行相关的脚本插件来获取数据，实现对客户端主机资源的监控。 存在形式：守护进程(agent)模式，开启的端口5666</li></ul></blockquote><blockquote><ul><li>NSClient++：半被动模式，相当于linux系统的nrpe</li></ul></blockquote><blockquote><ul><li>NDOUtils（不推荐用） 存在位置：服务端 作用：用于将nagios的配置信息和各event产生的数据存入数据库中，以实现对这些数据的检索和处理。</li></ul></blockquote><blockquote><ul><li>NSCA：纯被动模式---&gt;用在分布式监控环境中 位置：NSCA需要同时安装在nagios的服务器端和客户端</li></ul></blockquote><h2 id="软件版本" tabindex="-1">软件版本</h2><blockquote><p>nagios版本：4.3.1 nagios-plugins版本：2.2.1 nrpe版本：3.1.0</p></blockquote><h2 id="实现环境" tabindex="-1">实现环境</h2><p>nagios运行在LAMP环境下（如果还没有安装LAMP环境，可以参考下我的<a href="http://www.jianshu.com/p/b25afb669337" target="_blank" rel="noreferrer">安装LNMP文章</a>，因为我已经编译安装了php和Mysql，本文直接采取yum 方式安装apache，当然也可以采取编译方式安装apache。看个人喜好和公司需求）</p><blockquote><p>Centos版本：CentOS Linux release 7.3.1611 (Core) 64位 Apache版本：Apache/2.4.6 Nginx版本: nginx 1.12.0 Mysql版本：mysql 5.7.18 PHP版本：php 7.1.4</p></blockquote><h2 id="下载nagios软件及插件包" tabindex="-1">下载nagios软件及插件包</h2><p>下载慢的话可以去我的<a href="https://share.weiyun.com/d0e448b40b29665a47f3af9a88c68d87" target="_blank" rel="noreferrer">网盘下载</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios ~]# cd /software/</span></span>
...
<span class="line"><span style="color:#24292e;">-rw-r--r--   1 root  root    501028 4月  17 22:36 nrpe-3.1.0.tar.gz</span></span></code></pre></div><h2 id="安装nagios-server服务端" tabindex="-1">安装nagios-server服务端</h2><h3 id="安装依赖包" tabindex="-1">安装依赖包</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios software]# yum -y install httpd httpd-devel gcc glibc glibc-common gd gd-devel perl-devel perl-CPAN fcgi perl-FCGI perl-FCGI-ProcManager</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@nagios software]# yum -y install httpd httpd-devel gcc glibc glibc-common gd gd-devel perl-devel perl-CPAN fcgi perl-FCGI perl-FCGI-ProcManager</span></span></code></pre></div><h3 id="解压nagios源码包" tabindex="-1">解压nagios源码包</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios software]# tar zxvf nagios-4.3.1.tar.gz</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@nagios software]# tar zxvf nagios-4.3.1.tar.gz</span></span></code></pre></div><h3 id="进入解压后的目录" tabindex="-1">进入解压后的目录</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios software]# cd nagios-4.3.1/</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@nagios software]# cd nagios-4.3.1/</span></span></code></pre></div><h3 id="创建ngaios用户和组-把nginx启动用户www加入到nagios相关组" tabindex="-1">创建ngaios用户和组（把nginx启动用户www加入到nagios相关组）</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nagios-4.3.1]# useradd nagios -s /sbin/nologin </span></span>
...
<span class="line"><span style="color:#24292e;">[root@nagios nagios-4.3.1]# id -n -G www</span></span></code></pre></div><h3 id="配置nagios" tabindex="-1">配置nagios</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@client1 nagios-4.3.1]# ./configure --with-command-group=nagcmd</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@client1 nagios-4.3.1]# ./configure --with-command-group=nagcmd</span></span></code></pre></div><h3 id="编译和安装" tabindex="-1">编译和安装</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nagios-4.3.1]# make all</span></span>
...
<span class="line"><span style="color:#24292e;">[root@nagios nagios-4.3.1]# /usr/local/nagios/bin/nagios -v /usr/local/nagios/etc/nagios.cfg</span></span></code></pre></div><h3 id="生成apache配置文件" tabindex="-1">生成apache配置文件</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nagios-4.3.1]# make install-webconf</span></span>
...
<span class="line"><span style="color:#24292e;">*** Nagios/Apache conf file installed ***</span></span></code></pre></div><h3 id="生成nagios-web界面的验证信息" tabindex="-1">生成nagios web界面的验证信息</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nagios-4.3.1]# htpasswd -c /usr/local/nagios/etc/htpasswd.users nagios</span></span>
...
<span class="line"><span style="color:#24292e;"> LoadModule php7_module        modules/libphp7.so</span></span></code></pre></div><h3 id="apache配置文件参考" tabindex="-1">apache配置文件参考</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios httpd]# grep -v &#39;^$&#39; /etc/httpd/conf/httpd.conf|grep -v &#39;#&#39;</span></span>
...
<span class="line"><span style="color:#24292e;">IncludeOptional conf.d/*.conf</span></span></code></pre></div><h3 id="重新编译一下php-使其直接apache-也就是编译参数加上-with-apxs2" tabindex="-1">重新编译一下php，使其直接apache（也就是编译参数加上--with-apxs2）</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nagios-4.3.1]# cd /software/php-7.1.4/</span></span>
...
<span class="line"><span style="color:#24292e;">-rwxr-xr-x 1 root root 38908880 4月  24 10:34 /etc/httpd/modules/libphp7.so    ===&gt;    可以看到这个模块已经生成</span></span></code></pre></div><h3 id="启动apache" tabindex="-1">启动apache</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios httpd]# systemctl start httpd</span></span>
...
<span class="line"><span style="color:#24292e;">[root@nagios httpd]# systemctl enable httpd</span></span></code></pre></div><h3 id="启动nagios" tabindex="-1">启动nagios</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">chkconfig nagios on</span></span>
...
<span class="line"><span style="color:#24292e;">/etc/init.d/nagios start</span></span></code></pre></div><h3 id="在浏览器输入ip-8080-nagios测试nagios-web页面是否可以打开" tabindex="-1">在浏览器输入ip:8080/nagios测试nagios-web页面是否可以打开</h3><p><img src="http://upload-images.jianshu.io/upload_images/4262139-9928ac01cfdf8142.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-55e6ef5cb388a862.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p><img src="http://upload-images.jianshu.io/upload_images/4262139-9ba83971133bb8df.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><br><h2 id="安装nagios-plugins插件" tabindex="-1">安装nagios-plugins插件</h2><h3 id="解压nagios-plugins源码包" tabindex="-1">解压nagios-plugins源码包</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios httpd]# cd /software/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@nagios software]# tar zxvf nagios-plugins-2.2.1.tar.gz</span></span></code></pre></div><h3 id="进入解压后的目录进行配置" tabindex="-1">进入解压后的目录进行配置</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios software]# cd nagios-plugins-2.2.1/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@nagios nagios-plugins-2.2.1]# ./configure --with-nagios-user=nagios --with-nagios-group=nagcmd --enable-perl-modules</span></span></code></pre></div><h3 id="编译及安装" tabindex="-1">编译及安装</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nagios-plugins-2.2.1]# make &amp;&amp; make install</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@nagios nagios-plugins-2.2.1]# make &amp;&amp; make install</span></span></code></pre></div><br><h2 id="安装nrpe" tabindex="-1">安装nrpe</h2><h3 id="解压nrpe源码包" tabindex="-1">解压nrpe源码包</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nagios-plugins-2.2.1]# cd /software/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@nagios software]# tar zxvf nrpe-3.1.0.tar.gz</span></span></code></pre></div><h3 id="进去解压后的目录进行配置" tabindex="-1">进去解压后的目录进行配置</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios software]# cd nrpe-3.1.0/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@nagios nrpe-3.1.0]# ./configure</span></span></code></pre></div><h3 id="编译及安装-1" tabindex="-1">编译及安装</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nrpe-3.1.0]# make all</span></span>
...
<span class="line"><span style="color:#24292e;">[root@nagios nrpe-3.1.0]# cp sample-config/nrpe.cfg /usr/local/nagios/etc/nrpe.cfg</span></span></code></pre></div><h3 id="安装完成后-查看下libexec下面是否有插件" tabindex="-1">安装完成后，查看下libexec下面是否有插件</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nrpe-3.1.0]# ls /usr/local/nagios/libexec/</span></span>
...
<span class="line"><span style="color:#24292e;">check_file_age  check_load          check_ntp          check_simap     check_wave    utils.sh</span></span></code></pre></div><h3 id="启动nrpe-并测试服务端本地是否可以连通" tabindex="-1">启动nrpe，并测试服务端本地是否可以连通</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nrpe-3.1.0]# /usr/local/nagios/bin/nrpe -d -c /usr/local/nagios/etc/nrpe.cfg </span></span>
...
<span class="line"><span style="color:#24292e;">DISK OK - free space: / 4201 MB (24.15% inode=97%);| /=13192MB;13915;15654;0;17394</span></span></code></pre></div><br><h2 id="服务端配置" tabindex="-1">服务端配置</h2><p>nrpe连接客户端机器测试是否可以连通，然后执行一个监控命令（如果不通的话可能是因为selinux和防火墙没关闭而造成的）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios nrpe-3.1.0]# /usr/local/nagios/libexec/check_nrpe -H 172.16.0.20</span></span>
...
<span class="line"><span style="color:#24292e;">authorized_for_all_host_commands=nagiosadmin,nagios</span></span></code></pre></div><h3 id="修改nagios-cfg-自定义一些配置" tabindex="-1">修改nagios.cfg（自定义一些配置）</h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@nagios etc]# vi nagios.cfg +34</span></span>
...
<span class="line"><span style="color:#24292e;">172.16.0.18 nagios nagios.com</span></span></code></pre></div><br>`,148),t=s(`<br><p>监视物理组件的高级 Linux 命令（仅供参考）</p><blockquote><p>内存：top free、vmstat、mpstat、iostat、sar CPU：top vmstat、mpstat、iostat、sar I/O：vmstat、mpstat、iostat、sar 进程：ipcs、ipcrm 负载：uptime</p></blockquote><hr><br><h2 id="一键安装nagios命令参考" tabindex="-1">一键安装nagios命令参考</h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#############nagios-server-install########################</span></span>
...
<span class="line"><span style="color:#24292e;">/usr/local/nagios/libexec/check_nrpe -H localhost -c check_disk</span></span></code></pre></div><p><strong>总结：</strong> 多多查看nagios日志和mail日志，进行排错。</p>`,8);function i(r,g,d,y,h,u){return e(),p("div",null,[o,n(" *** ## nagios客户端的安装 ### 下载nagios-plugin和nrpe插件 "),c,n(" *** 报错2（发送外部邮件的时候，这种本地形式的发件人和发件地址容易被误认为垃圾邮件而拒收。） ![](http://upload-images.jianshu.io/upload_images/4262139-60dbb010c9f05c1d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240) 解决方法，见上面配置mail发件人smtp信息。 "),t])}const k=a(l,[["render",i]]);export{_ as __pageData,k as default};
