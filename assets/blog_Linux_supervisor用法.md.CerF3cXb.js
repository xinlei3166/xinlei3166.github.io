...
<span class="line"><span> superviso 14685 root    4u  IPv4 20155719      0t0  TCP *:etlservicemgr (LISTEN)</span></span></code></pre></div><p>现在通过 <a href="http://ip:9001/" target="_blank" rel="noreferrer">http://ip:9001/</a> 就可以查看supervisor的web界面了(默认用户名及密码是user和123)，当然目前还没有加入任何监控的程序。</p><p><img src="https://resources-r2.xinlei3166.com/images/XnqmIH5.png" alt="img"></p><p>下面写一个简单的python脚本，用来验证supervisor的监控效果。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#cat /root/temp/test_http.py   ###以下即是test_http.py脚本中的代码</span></span>
...
<span class="line"><span>host = 0.0.0.0</span></span></code></pre></div><p>一切顺利的话，可通过页面<a href="http://ip:5000" target="_blank" rel="noreferrer">http://ip:5000</a>，用户名，密码都是admin，最终的效果如下所示： <img src="https://resources-r2.xinlei3166.com/images/0UBx7qF.png" alt="img"></p><p>cesi repo上的示例效果：</p><p><img src="https://resources-r2.xinlei3166.com/images/image1-upload.png" alt="img"></p><p>记录下用法学习使用。</p><p>转载自：<a href="https://www.cnblogs.com/smail-bao/p/5673434.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/smail-bao/p/5673434.html</a></p>`,76),i=[t];function r(l,o,c,u,d,h){return n(),a("div",null,i)}const m=s(e,[["render",r]]);export{g as __pageData,m as default};
