...
<span class="line"><span>/usr/local/nagios/libexec/check_nrpe -H localhost -c check_disk</span></span></code></pre></div><p><strong>总结：</strong> 多多查看nagios日志和mail日志，进行排错。</p>`,8);function o(r,g,d,h,u,m){return e(),p("div",null,[l,n(" *** ## nagios客户端的安装 ### 下载nagios-plugin和nrpe插件 "),c,n(" *** 报错2（发送外部邮件的时候，这种本地形式的发件人和发件地址容易被误认为垃圾邮件而拒收。） ![](https://resources-r2.xinlei3166.com/images/4262139-60dbb010c9f05c1d.png) 解决方法，见上面配置mail发件人smtp信息。 "),t])}const k=a(i,[["render",o]]);export{_ as __pageData,k as default};
