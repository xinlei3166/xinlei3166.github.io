import{_ as s,o as i,c as a,ag as n}from"./chunks/framework.BwfKdYSM.js";const y=JSON.parse('{"title":"Django-Nginx-uwsgi","description":"","frontmatter":{"title":"Django-Nginx-uwsgi","tags":["Python","Nginx","Uwsgi"],"categories":["Python"]},"headers":[],"relativePath":"Python/Django-Nginx-uwsgi.md","filePath":"Python/Django-Nginx-uwsgi.md","lastUpdated":1625641181000}'),l={name:"Python/Django-Nginx-uwsgi.md"},t=n(`<h3 id="在开发环境下调试好python项目之后-把项目迁移到nginx上面" tabindex="-1">在开发环境下调试好python项目之后，把项目迁移到nginx上面 <a class="header-anchor" href="#在开发环境下调试好python项目之后-把项目迁移到nginx上面" aria-label="Permalink to &quot;在开发环境下调试好python项目之后，把项目迁移到nginx上面&quot;">​</a></h3><h3 id="首先把django-admin的静态文件目录复制一份到你设置的static文件目录下" tabindex="-1">首先把django admin的静态文件目录复制一份到你设置的static文件目录下： <a class="header-anchor" href="#首先把django-admin的静态文件目录复制一份到你设置的static文件目录下" aria-label="Permalink to &quot;首先把django admin的静态文件目录复制一份到你设置的static文件目录下：&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">python manage.py collectstatic</span></span></code></pre></div><h3 id="关闭settings-py中的debug-关闭debug之后staticfiles就不生效了-需要在nginx配置静态文件的访问。" tabindex="-1">关闭settings.py中的debug，关闭debug之后staticfiles就不生效了，需要在nginx配置静态文件的访问。 <a class="header-anchor" href="#关闭settings-py中的debug-关闭debug之后staticfiles就不生效了-需要在nginx配置静态文件的访问。" aria-label="Permalink to &quot;关闭settings.py中的debug，关闭debug之后staticfiles就不生效了，需要在nginx配置静态文件的访问。&quot;">​</a></h3><h3 id="安装uwsgi" tabindex="-1">安装uwsgi <a class="header-anchor" href="#安装uwsgi" aria-label="Permalink to &quot;安装uwsgi&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">pip install uwsgi</span></span></code></pre></div><h3 id="创建wsgi文件" tabindex="-1">创建wsgi文件： <a class="header-anchor" href="#创建wsgi文件" aria-label="Permalink to &quot;创建wsgi文件：&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">root</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">server1 testweb]</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># pwd</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">application </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> get_wsgi_application()</span></span></code></pre></div><h3 id="创建ini配置文件" tabindex="-1">创建ini配置文件： <a class="header-anchor" href="#创建ini配置文件" aria-label="Permalink to &quot;创建ini配置文件：&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@server1 testweb]# pwd</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>daemonize = /var/log/uwsgi.log</span></span></code></pre></div><h3 id="启动uwsgi" tabindex="-1">启动uwsgi： <a class="header-anchor" href="#启动uwsgi" aria-label="Permalink to &quot;启动uwsgi：&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@server1 testweb]# uwsgi --ini app.ini</span></span></code></pre></div><h3 id="也可编写uwsgi启动脚本" tabindex="-1">也可编写uwsgi启动脚本： <a class="header-anchor" href="#也可编写uwsgi启动脚本" aria-label="Permalink to &quot;也可编写uwsgi启动脚本：&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">server1 </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">~</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># cat /etc/init.d/uwsgi </span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">if</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [ </span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">$</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> = start ]</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">then</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> psid</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">\`ps aux </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">|</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> grep </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">&quot;zh&quot;</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> |</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> grep </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">-</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">v </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">&quot;grep&quot;</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> |</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;"> wc </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">-</span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">l\`</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> if</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [ </span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">$</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">psid </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">gt </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">4</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> ]</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> then</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> uwsgi </span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">--</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ini </span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">$</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uwsgi_ini</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> fi</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">elif</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [ </span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">$</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> = stop ];then</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">elif</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [ </span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">$</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> = restart ];then</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> echo </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;Usages: [start|stop|restart]&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fi</span></span></code></pre></div><h3 id="配置nginx-conf文件-添加下面一行内容" tabindex="-1">配置nginx.conf文件，添加下面一行内容： <a class="header-anchor" href="#配置nginx-conf文件-添加下面一行内容" aria-label="Permalink to &quot;配置nginx.conf文件，添加下面一行内容：&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span> include /usr/local/nginx/conf/conf.d/*;</span></span></code></pre></div><h3 id="在conf-d新建app-conf文件" tabindex="-1">在conf.d新建app.conf文件： <a class="header-anchor" href="#在conf-d新建app-conf文件" aria-label="Permalink to &quot;在conf.d新建app.conf文件：&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">server1 conf.d]</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># cat app01.conf </span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">client_max_body_size </span><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;--shiki-light-font-style:italic;--shiki-dark-font-style:italic;">75M</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">; </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># adjust to taste</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h3 id="重新启动nginx" tabindex="-1">重新启动Nginx： <a class="header-anchor" href="#重新启动nginx" aria-label="Permalink to &quot;重新启动Nginx：&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">server1 conf.d]</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># /etc/init.d/nginx stop</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[root</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">server1 conf.d]</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># /etc/init.d/nginx start</span></span></code></pre></div><h3 id="访问页面测试" tabindex="-1">访问页面测试： <a class="header-anchor" href="#访问页面测试" aria-label="Permalink to &quot;访问页面测试：&quot;">​</a></h3><p><img src="http://upload-images.jianshu.io/upload_images/4262139-c396569a123c865f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""><img src="http://upload-images.jianshu.io/upload_images/4262139-a6aaeea6463181f2.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" alt=""></p><p>调试过程中，报错多多查看日志排错。</p>`,23),p=[t];function h(k,e,E,g,r,d){return i(),a("div",null,p)}const o=s(l,[["render",h]]);export{y as __pageData,o as default};
