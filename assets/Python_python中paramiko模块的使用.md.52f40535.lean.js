import{_ as s,v as a,b as n,R as p}from"./chunks/framework.780d3f64.js";const h=JSON.parse('{"title":"python中paramiko模块的使用","description":"","frontmatter":{"title":"python中paramiko模块的使用","tags":["Python","Paramiko"],"categories":["Python"]},"headers":[],"relativePath":"Python/python中paramiko模块的使用.md","filePath":"Python/python中paramiko模块的使用.md","lastUpdated":1625641181000}'),l={name:"Python/python中paramiko模块的使用.md"},o=p(`<h2 id="paramiko" tabindex="-1">paramiko <a class="header-anchor" href="#paramiko" aria-label="Permalink to &quot;paramiko&quot;">​</a></h2><p>paramiko是一个用于做远程控制的模块，使用该模块可以对远程服务器进行命令或文件操作，值得一说的是，fabric和ansible内部的远程管理就是使用的paramiko来现实。</p><h2 id="_1、下载安装" tabindex="-1">1、下载安装 <a class="header-anchor" href="#_1、下载安装" aria-label="Permalink to &quot;1、下载安装&quot;">​</a></h2><p>pycrypto，由于 paramiko 模块内部依赖pycrypto，所以先下载安装pycrypto</p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">yum </span><span style="color:#F97583;">-</span><span style="color:#E1E4E8;">y install python</span><span style="color:#F97583;">-</span><span style="color:#E1E4E8;">devel</span></span>
...
<span class="line"><span style="color:#24292E;">pip3 install paramiko</span></span></code></pre></div><h2 id="_2、模块使用" tabindex="-1">2、模块使用 <a class="header-anchor" href="#_2、模块使用" aria-label="Permalink to &quot;2、模块使用&quot;">​</a></h2><h3 id="执行命令-用户名-密码" tabindex="-1">执行命令 - 用户名+密码 <a class="header-anchor" href="#执行命令-用户名-密码" aria-label="Permalink to &quot;执行命令 - 用户名+密码&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> paramiko</span></span>
...
<span class="line"><span style="color:#24292E;">ssh.close()</span></span></code></pre></div><h3 id="上传或下载文件-用户名-密码" tabindex="-1">上传或下载文件 - 用户名+密码 <a class="header-anchor" href="#上传或下载文件-用户名-密码" aria-label="Permalink to &quot;上传或下载文件 - 用户名+密码&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 上传文件</span></span>
...
<span class="line"><span style="color:#24292E;">t.close()</span></span></code></pre></div><h3 id="执行命令-密匙" tabindex="-1">执行命令 - 密匙 <a class="header-anchor" href="#执行命令-密匙" aria-label="Permalink to &quot;执行命令 - 密匙&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> paramiko</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">ssh.close()</span></span></code></pre></div><h3 id="上传或下载文件-密匙" tabindex="-1">上传或下载文件 - 密匙 <a class="header-anchor" href="#上传或下载文件-密匙" aria-label="Permalink to &quot;上传或下载文件 - 密匙&quot;">​</a></h3><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 上传文件</span></span>
<span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> paramiko</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="color:#24292E;">t.close()</span></span></code></pre></div>`,14),e=[o];function t(c,r,y,E,i,F){return a(),n("div",null,e)}const m=s(l,[["render",t]]);export{h as __pageData,m as default};
