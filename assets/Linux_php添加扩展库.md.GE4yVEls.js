import{_ as n,o as s,c as a,ag as p}from"./chunks/framework.BwfKdYSM.js";const d=JSON.parse('{"title":"php添加扩展库","description":"","frontmatter":{"title":"php添加扩展库","tags":["Linux","PHP"],"categories":["Linux"]},"headers":[],"relativePath":"Linux/php添加扩展库.md","filePath":"Linux/php添加扩展库.md","lastUpdated":1625641181000}'),i={name:"Linux/php添加扩展库.md"},x=p(`<h3 id="首先进入解压后的php源码包目录" tabindex="-1">首先进入解压后的php源码包目录 <a class="header-anchor" href="#首先进入解压后的php源码包目录" aria-label="Permalink to &quot;首先进入解压后的php源码包目录&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ~]# cd /software/php-7.1.4/</span></span>
...
<span class="line"><span>drwxrwxr-x.  5 junxi junxi   12288 4月  19 16:56 Zend</span></span></code></pre></div><h3 id="进入ext目录" tabindex="-1">进入ext目录 <a class="header-anchor" href="#进入ext目录" aria-label="Permalink to &quot;进入ext目录&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios php-7.1.4]# cd ext/</span></span></code></pre></div><h3 id="ext目录下都是php扩展库" tabindex="-1">ext目录下都是php扩展库 <a class="header-anchor" href="#ext目录下都是php扩展库" aria-label="Permalink to &quot;ext目录下都是php扩展库&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ext]# ll</span></span>
...
<span class="line"><span>drwxrwxr-x.  4 junxi junxi 4096 4月  19 16:51 zlib</span></span></code></pre></div><h3 id="例如我们需要使用sockets扩展模块" tabindex="-1">例如我们需要使用sockets扩展模块 <a class="header-anchor" href="#例如我们需要使用sockets扩展模块" aria-label="Permalink to &quot;例如我们需要使用sockets扩展模块&quot;">​</a></h3><p>进入sockets扩展库目录下</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios ext]# cd sockets/</span></span>
...
<span class="line"><span>-rw-rw-r--. 1 junxi junxi  4031 4月  11 23:37 windows_common.h</span></span></code></pre></div><h3 id="使用phpize命令来扩展php扩展模块-建立php的外挂模块" tabindex="-1">使用phpize命令来扩展php扩展模块，建立php的外挂模块 <a class="header-anchor" href="#使用phpize命令来扩展php扩展模块-建立php的外挂模块" aria-label="Permalink to &quot;使用phpize命令来扩展php扩展模块，建立php的外挂模块&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios sockets]# /usr/local/php/bin/phpize </span></span>
...
<span class="line"><span>Zend Extension Api No:   320160303</span></span></code></pre></div><h3 id="编译和安装" tabindex="-1">编译和安装 <a class="header-anchor" href="#编译和安装" aria-label="Permalink to &quot;编译和安装&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios sockets]# ./configure --prefix=/usr/local/php/lib --with-php-config=/usr/local/php/bin/php-config --enable-sockets</span></span>
<span class="line"><span></span></span>
<span class="line"><span>[root@nagios sockets]# make &amp;&amp; make install</span></span></code></pre></div><h3 id="查看扩展库模块存放目录下是否有我们新安装的扩展模块" tabindex="-1">查看扩展库模块存放目录下是否有我们新安装的扩展模块 <a class="header-anchor" href="#查看扩展库模块存放目录下是否有我们新安装的扩展模块" aria-label="Permalink to &quot;查看扩展库模块存放目录下是否有我们新安装的扩展模块&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[root@nagios lib]# ll /usr/local/php/lib/php/extensions/no-debug-non-zts-20160303/</span></span>
...
<span class="line"><span>-rwxr-xr-x 1 root root  366176 4月  27 17:18 sockets.so</span></span></code></pre></div><h3 id="接下来我们只要在php-ini文件里添加扩展的模块名即可。" tabindex="-1">接下来我们只要在php.ini文件里添加扩展的模块名即可。 <a class="header-anchor" href="#接下来我们只要在php-ini文件里添加扩展的模块名即可。" aria-label="Permalink to &quot;接下来我们只要在php.ini文件里添加扩展的模块名即可。&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>extension=sockets.so</span></span></code></pre></div><h3 id="然后重启php-fpm服务和web服务。" tabindex="-1">然后重启php-fpm服务和web服务。 <a class="header-anchor" href="#然后重启php-fpm服务和web服务。" aria-label="Permalink to &quot;然后重启php-fpm服务和web服务。&quot;">​</a></h3>`,18),r=[x];function l(e,u,c,w,t,o){return s(),a("div",null,r)}const h=n(i,[["render",l]]);export{d as __pageData,h as default};
